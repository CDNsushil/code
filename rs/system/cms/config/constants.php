...
|--------------------------------------------------------------------------
|
| Which version of CMS is currently running?
|
*/
...
|--------------------------------------------------------------------------
|
| When was the current version of CMS released - in US Date format now.
|
*/
...
/*------Security token for referral system(Services)-------*/
define('REFERRAL_TOKEN','1@#$Was??');
