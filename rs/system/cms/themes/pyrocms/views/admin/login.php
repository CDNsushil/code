...
<div id="container" class="login-screen">
	<section id="content">
		<div id="content-body">
            ...
            <div class="animated bounceIn login_heading"><?php echo $this->settings->site_name; ?></div>
						...
						<li class="animated fadeIn" id="login-save">
							<label for="remember-check" id="login-remember">
								...
								<?php echo lang('user:remember'); ?> | 
								 <a href="<?php echo 'users/forgot-password/'.encode('1'); ?>" class="pull-right"><span class="white_color">Forgot Password? </span></a>
							</label>
						</li>
					</ul>
...
<footer id="login-footer">
	<div class="wrapper animated fadeIn" id="login-credits">
		Copyright &copy; 2009 - <?php echo date('Y'); ?> Syrecohk 
	</div>
</footer>
</body>
</html>
