...
Asset::js('chat/script.js');
Asset::js('chat/jScrollPane/jquery.mousewheel.js');
Asset::js('chat/jScrollPane/jScrollPane.min.js');
...
<?php Asset::css(array('jquery/colorbox.css', 'codemirror.css', 'animate/animate.css','chat/chat.css','chat/jScrollPane.css','chat/page.css')); ?>
