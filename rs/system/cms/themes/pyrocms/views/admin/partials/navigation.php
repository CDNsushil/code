<ul class="primary-nav">
	...
	<li id="dashboard-link"><?php echo anchor('admin', lang('global:dashboard'), 'class="top-link '.( ! $this->module ? 'current ' : '').'"') ?></li>
		...
		foreach ($menu_items as $key => $menu_item)
		{
			...
			{
				if (array_key_exists("lang:cp:edit_profile_label",$menu_item))
				{
					unset($menu_item['lang:cp:edit_profile_label']);
				}
			...
			echo '<li><a href="'.site_url().'admin/logout" class="top-link">Logout</a>';
		?>
