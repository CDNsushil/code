...
<p>Η επιλογή \"Να απαιτείται το ακριβές URI\" είναι ένα έξυπνο μικρό εργαλείο που σας επιτρέπει να δίνεται παραμέτρους στην URL. Εξ'ορισμού το CMS κοιτάει για μια σελίδα με
...
λέτε στο CMS ότι δεν υπάρχει πρόβλημα όταν δεν υπάρχει μια σελίδα με το όνομα Acme Widgtes. Θα φορτώσει την σελίδα Products και το 'acme-widgets' θα είναι απλώς μια παράμετρος.
