...
<p>El campo de \"¿Requiere que las uri coincidan exactamente?\" es una herramienta tan inteligente que le permite pasar parámetros en la URL. Por defecto CMS busca una página con
el slug de \"acme-widgets\" el cual es el descendiente \"products\" cuando usted visita ".site_url('products/acme-widgets').". Al marcar esta casilla en la página de Products, le está diciendo CMS que está bien si no hay una página llamada Acme Widgets.
