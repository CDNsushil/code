 ...
 *
 * @author  CDN Team
 * @package CMS\Core\Modules\Settings
 */
class Module_Settings extends Module
{
	...
	public function admin_menu(&$menu)
	{
		...
		$menu['lang:cp:nav_settings'] = array(
			...
			'lang:settings:general_settings'	=> 'admin/settings',
			'lang:settings:configuration'			=> 'admin/settings/configuration',
		); 
	...
	public function install()
	{
		...
		$settings = array(
			...
			'dashboard_rss' => array(
				...
				'type' => 'text',
				'default' => 'https://www.syrecohk.com/blog/rss/all.rss',
				'value' => '',
				'options' => '',
				'is_required' => 0,
				'is_gui' => 1,
