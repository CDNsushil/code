...
$lang['settings:configuration']					= 'Configuration';
$lang['settings:general_settings']				= 'General Settings';
// messages
$lang['settings:no_settings']					= 'There are currently no settings.';
$lang['settings:save_success']					= 'Your settings were saved!';
$lang['settings:paypal_id']						= 'Paypal Id';


//custom mesage

$lang['settings:emp_feedback']					= 'Employee Feedback';
$lang['settings:email_error']					= 'Email does not send! Please check contact email settings.';
$lang['settings:user_details']					= 'User Details';

//configuration
$lang['settings:referral_point']				= 'Referral Point';
$lang['settings:referral_point_amt']			= 'Referral Point Amt';
$lang['settings:currency']						= 'Currency';
$lang['settings:minimum_referral_point']		= 'Minimum Referral Point';
$lang['settings:referral_success_msg']			= 'Configuration settings saved.';
$lang['settings:referral_error_msg']			= 'Request Failed! Please Try Again.';
$lang['settings:support_email']					= 'Support Email';
$lang['settings:each_referral_point_worth']	='Each referral point is worth?';
