<?php //this si merchant login form?>
<h2 class="page-title" id="page_title"><?php echo lang('user:login_m'); ?></h2>
...
<?php echo form_open(uri_string(), array('id'=>'login'), array('redirect_to' => $redirect_to)) ?>
<ul>
	<li>
