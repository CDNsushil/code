...
class CI_Email {
	...
	public $useragent	= 'syrecohk';
	public $mailpath	= '/usr/sbin/sendmail';	// Sendmail path
	public $protocol	= 'smtp';		// mail/sendmail/smtp
	public $smtp_host	= '184.107.217.244';			// SMTP Server. Example: mail.earthlink.net
	public $smtp_user	= 'admin@cdnsolutionsgroup.com';			// SMTP Username
	public $smtp_pass	= 'llB8eTk=oKtG';			// SMTP Password
	public $smtp_port	= 25;			// SMTP Port
	public $smtp_timeout	= 60;			// SMTP Timeout in seconds
	public $smtp_crypto	= null;			// SMTP Encryption. Can be null, tls or ssl.
	public $wordwrap	= TRUE;			// TRUE/FALSE  Turns word-wrap on/off
	public $wrapchars	= 76;			// Number of characters to wrap at.
	public $mailtype	= 'html';		// text/html  Defines email formatting
	public $charset		= 'utf-8';		// Default char set: iso-8859-1 or us-ascii
	public $multipart	= 'mime';		// "mixed" (in the body) or "related" (separate)
