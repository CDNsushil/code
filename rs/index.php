...
if ( ! file_exists('system/cms/config/database.php'))
{
	...
	{
		header('Status: 404');
		exit('CMS is missing system/cms/config/database.php and cannot find the installer folder. Does your server have permission to access these files?');
	}
 ...
 *---------------------------------------------------------------
 *
 * Should CMS run as a demo, meaning no destructive actions
