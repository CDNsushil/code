...
class MY_Controller extends MX_Controller {
	...
	public function __construct()
	{
		...
		$this->sSettings = $this->topics_m->get_settings();
				...
				//This is the email template data coming from database as an array...
				//Parse Templates        
	...
	public function forums_page_construct($page, $title, $data)
	{
		...
		$this->forum_template->set_partial('header', 'core/main/header');
		$this->forum_template->set_partial('toppanel', 'core/main/toppanel');
		$this->forum_template->set_partial('page_header', 'forums/sections/page_header');
		$this->forum_template->set_partial('messages', 'core/sections/messages');
		$this->forum_template->set_partial('footer', 'core/main/footer');
		...
		$this->forum_template->set_metadata('keywords', $keywords);
		$this->forum_template->set_metadata('description', $description);
		...
		// Get the sites theme 
		$this->forum_template->set_theme($sitetheme);
		$this->forum_template->set_layout($sitelayout);
		...
		$this->forum_template->title($title);
        ...
        return $this->forum_template->build($page, $data,true);
	}
	...
	public function admin_construct($page, $title, $data)
	{
		...
		$this->forum_template->set_partial('header', 'admin/main/header');
		$this->forum_template->set_partial('page_header', 'admin/sections/page_header');
		$this->forum_template->set_partial('navigation', 'admin/sections/navigation');
		$this->forum_template->set_partial('left_sidebar', 'admin/sections/left_sidebar');
		$this->forum_template->set_partial('messages', 'admin/sections/messages');
		$this->forum_template->set_partial('footer', 'admin/main/footer');
		...
		// Construct the template
		$this->forum_template->title($title);
		$this->forum_template->build($page, $data);
