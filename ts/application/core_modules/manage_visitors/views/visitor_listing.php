...
<div id="wrapperL">
	<h1><?php echo $this->lang->line('visitorsLog');?></h1>
	...
	<!--Top menu home link -->
	<div class="box menu">
		<a href="<?php echo site_url(SITE_AREA_SETTINGS.'manage_visitors');?>"><?php echo $this->lang->line('genreHomeLink');?></a> 
	...
	<div class="box" id="showVisitorsList">
		<?php 
			echo $this->load->view("visitor_view_listing"); 
		?>
	</div>
</div>
