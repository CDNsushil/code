...
echo '
'.form_open_multipart('admin/settings/manage_pressRelease/save_pressRelease', 'class="form" id="add_edit_pressRelease" name="add_edit_pressRelease"').'
...
<div class="width599px fl">
	<ul class="ul_relative">
		...
		<li> 
		<div class="tds-button fr pr25">
			<div class="seprator_20"></div>
						<input type="submit" value="Save" name="save">
						<input type="button" value="Cancel" onClick="window.location.href=\''.base_url('admin/settings/manage_pressRelease').'\'" class="canclebtn">
					</div>';
