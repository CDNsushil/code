...
<div class="width400px fr">
		...
		<div class="width320px fr " >
			<div id="uploadFileByJquery"></div>
			<div class="line"></div>
		</div>
		<?php
			//here news video upload form
			$this->load->view("manage_common/admin_video_upload");
			$countPR=0;
			$icon='video1.png';
					...
					<div class="row fr  width320px pb10">
					  <div class=" cell  extract_content_bg " id="rowData3">
						<div class="extract_img_wp "> 
							<img  onclick="openPlayerLightBox('popupBoxWp','popup_box','/common/playCommonVideo','<?php echo $MediaFileData['fileId'];?>','0','0','0');"  src="<?php echo base_url('images/icons/'.$icon);?>" class="formTip ptr maxWH30 ma">
						</div>
						<!--extract_img_wp-->
