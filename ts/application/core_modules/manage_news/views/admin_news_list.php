...
<div id="wrapperL">
	...
	<div class="box language">
		<p><a href="<?php echo BASEURL?>admin/settings/manage_news/add_edit_news"><b><?php echo $this->lang->line('create_New');?></b></a></p>
		<div id="contentLeft">
			<ul>
				<?php $sk=0;
				if($press_list)foreach($press_list as $k=>$press_lists){ 
					...
					<li id="recordsArray_<?php echo $press_lists['id']; ?>">
						<a href="<?php echo site_url('admin/settings/manage_news/index/'.$press_lists['id']);?>" class="get_link <?php echo $color;?> pb15">
	...
	<div class="box files">
		<?php
			if(isset($press_list[$sk])){
					$f=$press_list[$sk];
					echo '<div class="fr">';
					echo ''.anchor('admin/settings/manage_news/add_edit_news/'.$f['id'].'', '<img src="'.base_url().'templates/assets/images/edit_icon.png" height="15px" width="15px" title="'.$this->lang->line('edit').'" />').'&nbsp;&nbsp;&nbsp;';
					echo ''.anchor('admin/settings/manage_news/delete_news/'.$f['id'].'', '<img src="'.base_url().'templates/assets/images/delete_icon.png" height="15px" width="15px" title="'.$this->lang->line('delete').'" onClick="return confirm(\'Are you sure you want to delete?\')" />').'&nbsp;&nbsp;&nbsp;&nbsp;';	
					echo '</div>';	
