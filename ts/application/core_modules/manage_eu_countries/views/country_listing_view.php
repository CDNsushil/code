...
<ul>
	<li>
		<div class="row">
			<div class="cell width150px b"><?php echo $this->lang->line('countryName');?></div>
	...
	if(isset($countryList) && !empty($countryList)){
		...
		<li>
		<div class="row">
			<div class="cell width150px"><?php echo $countryListing['countryName'];?></div>
			...
			?></div>
			<div class="cell">
				<a href="<?php echo base_url().SITE_AREA_SETTINGS.'manage_eu_countries/manage_country/'.$countryListing['countryId'];?>" class="formTip" title="<?php echo $this->lang->line('admin_edit');?>">
