...
echo ''.form_open(base_url(SITE_AREA_SETTINGS.'manage_eu_countries/edit_country'),$formAttributes).'
<div class="page_list">
	...
	$("#countryForm").validate({
		submitHandler: function() {
			...
			$.post(baseUrl+'admin/settings/manage_eu_countries/update_country',fromData, function(data) {
				if(data){
					window.location.href=baseUrl+'admin/settings/manage_eu_countries/edit_country/'+countryId;
				}
			});
		}
	});
