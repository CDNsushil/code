		...
		<div class="bdr_c9c9c9">
			...
			<div class="seprator_20"></div>
				...
				<div id="resend" class="tds-button Fright mr5 mb5"> 
					<a href="<?php echo site_url(SITE_AREA_SETTINGS.'manage_messaging/compose_mail/'.$messageId);?>"><span><div class="Fleft">Resend</div> <div class="icon-save-btn"></div> </span></a>
				</div>
		</div>
		<div class="clear"></div>
	</div>
