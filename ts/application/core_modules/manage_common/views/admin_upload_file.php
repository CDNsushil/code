...
<div id="uploadElementForm<?php echo $browseid;?>" class="width320px row fr dn" >
	...
	<form enctype="multipart/form-data" toggledivform="uploadElementForm" id="uploadmediaForm<?php echo $browseid;?>" name="uploadmediaForm" accept-charset="utf-8" method="post" action="<?php echo base_url(lang().'/admin/settings/manage_pressRelease/add_edit_PressReleaseNewsMaterial');?>" novalidate="novalidate">							
		<div class="row">
			<div class="fl">
				<label class="select_field">Title</label>
			</div>
			<div class=" fl">
				<input type="text" class="width_246px required" id="fileTitle<?php echo $browseid;?>" value="" name="fileTitle">										<div class="row wordcounter"></div>
			</div>
		</div>
	...
	$(document).ready(function(){
		...
		$("#uploadmediaForm").validate({
			submitHandler: function() {
				...
				var url = baseUrl+'admin/settings/manage_pressRelease/add_edit_PressReleaseNewsMaterial';
