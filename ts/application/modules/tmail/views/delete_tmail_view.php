     ...
     <div class="row form_wrapper">
			...
			<div class="row pt2 ">
                ...
                <div class="cell tab_left width_202">
                  <div class="tab_heading_global"><div class="tds-button-inbox fl mt5 ml10 btn_span_hover"><a href="#" onmouseup="mouseout_inputtmail(this)" onmousedown="mouseup_inputtmail(this)"><span class="font_arial">Compose
                  </span></a></div> </div>
                  <!--tab_heading-->
                </div>
                <div class="cell tab_right width_590">
                  <div class="tds-button-inbox Fright mt5 mr10 btn_span_hover"><a href="<?php echo base_url(lang().'/tmail/?show=trash') ?>" onmouseup="mouseout_inputtmail(this)" onmousedown="mouseup_inputtmail(this)"><span>Trash
                  </span></a></div>
                </div>
      ...
      <div class="clear"></div>
					...
					<div class="form_wrapper toggle pr5"  id="NEWS-Content-Box2" >
						...
						?>
							...
							<div class="width100percent minH900">
									...
									<div class="row width_791">
										<div class="label_wrapper_global cell heightAuto">
											...
											<label class=" height_30"><?php if($data->is_sender!='t') { ?>From
											<?php }else { ?>
											To
											<?php } ?>
											</label>
										...
										<div class=" cell frm_element_wrapper pl14">
											...
											<div class="fl font_opensans font_size13 ml15 mr15 mt5"><?php echo isGetUserName($data->tdsUid);?></div> 
				...
				<div class="tmail_bottomstrip fl"></div> 
