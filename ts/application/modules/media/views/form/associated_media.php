...
<div class="TabbedPanelsContent Associated_wrap width635 m_auto clearb">
        ...
        <div id="searchBoxDiv" class="<?php echo $searchdn;?>">
            <ul class="Purchase_input display_block pb8 fl ">
                <li class="fl position_relative">
                    <input class="font_wN minH26" type="text" name="keyWords" id="keywords" placeholder="Keywords" value="" onclick="placeHoderHideShow(this,'Keywords','hide')" onblur="placeHoderHideShow(this,'Keywords','show')">
                    <input name="Submit" type="submit" class="searchbtbbg search_pop" value="Submit"  />
                </li>
                <li class="fl">
                   ...
                   <input class="red p10 bdr_a0a0a0 fshel_bold search_pop width0 mr5" value="Search" type="button" />
                </li>
                ...
                foreach( $suportLinks as $suportLinks ) {
                    ...
                    <li id="supportingLi_<?php echo $suportLinks['id'];?>">
                        <span class="pl77"> 
                            ...
                            <?php echo $suportLinks['title']; ?> 
                            <span class="red fs12 fr">
                                <a href="javascript:void(0)" onclick="editSupportedMedia('<?php echo $suportLinks['id'];?>','<?php echo $suportLinks['title']; ?>')"> Edit</a> / 
    ...
    // set next url
    $data['nextPage'] = '/previewpublish/'.$elementId;;
    // set skip url
    $data['skipPage'] = '/previewpublish/'.$elementId;
    // set next step val
    $data['isNextstep'] = 1;
    $data['isPausestep'] = 1;
...
<script>
    ...
    function editSupportedMedia(supportLinkId,title) {
