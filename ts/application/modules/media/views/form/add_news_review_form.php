...
// set Collection Title 
$articleSubjectValue = (isset($projData->articleSubject))?$projData->articleSubject:'';
$articleSubjectInput =   array(
    'name'        =>  'articleSubject',
    'id'          =>  'articleSubject',
    'class'       =>  'required width527 min-height_25 mt14 bdr_adadad',
    'value'       =>  set_value('articleSubject')?set_value('articleSubject'):string_decode($projData->articleSubject),
    'wordlength'  =>  "1,15",
