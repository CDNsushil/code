...
echo form_open(base_url(lang().DIRECTORY_SEPARATOR.$this->router->fetch_class().DIRECTORY_SEPARATOR.$this->router->fetch_method().DIRECTORY_SEPARATOR.'saveProjectStatus'.DIRECTORY_SEPARATOR),$PubliciseForm); 
    ...
    ?>
<div class="c_1">
  <h3 class=" fs21 red  fnt_mouse bb_aeaeae"><?php echo $MW_PubliciseHeading;?></h3>
  ...
  <div class=" fs14 fr btn_wrap display_block mt5 font_weight">
    ...
    <button class="b_F1592A bdr_b5b5b5 fr pub_1 mr0 ui-button ui-widget ui-state-default ui-corner-all ui-button-text-only" type="submit" role="button" aria-disabled="false"><span class="ui-button-text"><?php echo $this->lang->line('finish');?></span></button>
  </div>
</div>
