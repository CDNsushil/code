...
<!--
	...
	<?php
		//This shows posts related with blog
		$frontFlag = 1;
		echo Modules::run("blog/blogArchive",$blogId,$frontFlag,$userId);
	?>
	</div> 
	<div class="row summery_right_archive_wrapper">
	<?php
		$frontFlag = 1;
		echo Modules::run("blog/blogCategories",$blogId,$frontFlag,$userId);
	?>
	</div>
	<div class="row summery_right_archive_wrapper">
	<?php 	
		...
		'onclick'=>"AJAX('".base_url(lang().'/blog/front_blog/'.$userId)."','frontPostsInfo','".encode($blogId)."','0');"));
	?>	
	</div>
	<div class="row summery_right_archive_wrapper">	
	<?php			
