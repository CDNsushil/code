...
?>
     <div class="box_wrap fl ">
        <h4 class=" mb16 red font_bold"><?php echo $this->lang->line($industryType.'_collection_key_cast'); ?></h4>
           ...
           <div class="viewport height140 ">
              <ul class="img_box overview  width_270 ">
                   <?php
                    ...
                    ?>
                     <li>
                            <div class="table_cell img_thum"><img src="<?php echo $userImage; ?>" alt="" /></div> 
