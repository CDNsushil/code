...
if($isAcutionFinish){ ?>
<div class="<?php echo ($showview=="project")?'fl':'fr'; ?>">    
<button class="pay_button red text_alighC  bgeff0e7 fl" type="button"><?php echo $this->lang->line('m_auction_finished'); ?></button>
<div class="sap_20"></div>
<span class="fl fs12 "><?php echo $this->lang->line('m_winning_bid'); ?></span> <span class="red fr  fs14 font_bold"><?php echo $currencySign.number_format($currentBidPrice,2); ?></span>
</div>
<?php }else{ ?>    
...
<div class="clearb">
    ...
    <button  onclick="<?php echo $functionBidProject ?>" class="pay_button red text_alighC donate_b bgeff0e7 fl" type="button">
...
<?php  }elseif($showview=="projectelement"){ ?>
   <button class="pay_button red text_alighC bgeff0e7 bidpopup mt0" onclick="<?php echo $functionBidProject ?>"  type="button"><?php echo $this->lang->line($industryType.'_bid_button'); ?></button>
<?php  } } ?>
