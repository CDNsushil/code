...
<div class="popup_gredient ">
	<div class="width510px pt24 pl20 pb20 pr20">
		...
		<div class="row">
			<div class="cell">
				<input type="text" value="<?php echo $consumptionTaxPercentage;?>" class="width90px number required" id="CTP" name="CTP">
			</div>
...
function submitProjectSpacificTax(){
	var CTP = $('#CTP').val();
	if(CTP > 0){
		$('#consumptionTaxPercentage').val(CTP);
