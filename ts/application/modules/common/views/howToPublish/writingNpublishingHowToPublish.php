			...
			<tr>
				...
				<td>
					...
					<div class="font_opensans font_size14 clr_444">
						...
						<div class="seprator_13"></div>
						When you have finished adding content go to the Writing & Publishing Index page and after you are happy with how your work looks in Preview, press Publish.
						<div class="seprator_13"></div>
					...
					<div class="width_476 pl32 pr20" id="Sell">
						...
						<div class="font_opensans font_size14 clr_444 howpub_discrip">
							...
							<div class="seprator_10"></div>
							<ul class="ml40">
								<li>You can put up an Extract to advertise you on-sale work. This will be seen on your Showcase, as will Pieces you add using Embed rather than Upload.</li>
