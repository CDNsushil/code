			...
			<tr>
				...
				<div class="width_476 pl32 pr20" id="Publish">
					...
					<div class="font_opensans font_size14 clr_444">
						...
						Filling in the fields in the Project section of Further Description creates your "cover": Your online equivalent of an album cover. In Further Description you can also tailor how each Piece will look on its Showcase page.
						<div class="seprator_13"></div>
						When you have finished adding content go to your Music & Audio Index page and after you are happy with how your work looks in Preview, press Publish.  
						<div class="seprator_13"></div>
						You can add to, or edit your Project at any time. Information relating to your Project will automatically update, but you need to individually publish each additional Piece you wish to add to your Project. Press Hide if you want to remove a Project or a Piece from your Showcase for a while.
					</div>
					<div class="clear"></div>
				...
				<div class="width_476 pl32 pr20" id="Sell">
						...
						<div class="font_opensans font_size14 clr_444 howpub_discrip">
							...
							<div class="seprator_10"></div>
							<ul class="ml40">
								<li>You can put up a Sample to advertise you on-sale work. This will be seen on your Showcase, as will Pieces you add using Embed rather than Upload.</li>
								<li>The Preview feature allows visitors hear the first 20 seconds of your for-sale Pieces. You can turn this off in the Project section of Further Description.</li>
								<li>You can combine 2 types of sales: Download and shipped Product. </li>
								<li>To sell you must set at least one Project price and you must Upload at least one Piece.</li>
								<li>You can also offer a Piece for individual sale, if you uploaded it.</li>
