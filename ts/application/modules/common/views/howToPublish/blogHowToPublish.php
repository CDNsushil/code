			...
			<tr>
				...
				<td>
					<div class="width_476 pl32 pr20">
						...
						<div class="font_opensans font_size14 clr_444 howpub_discrip">
							<div class="seprator_3"></div>
								Before you can publish your first Post in your Blog you need to fill in the Required Fields in: 
							<div class="clear"></div>
							<div class=" seprator_7"></div>
							<ul class=" ml15">
								<li><a class="ulLink" href="<?php echo base_url('blog/blogForm');?>">Blog Settings</a>.</li>
							</ul>
							<div class="clear"></div>
						</div>
						...
						<div class="row text_alignC width100percent">
							<div class="AI_table">
								<div class="AI_cell">
									<img src="<?php echo site_url().'images/how_to_publish/blogsetting.png';?>" alt="buttons"/>
								</div>
							</div>
						</div>
					...
					<div class="font_opensans font_size14 clr_444">
						Your Blog Settings will be automatically added to your Showcase, but you need to individually publish your Posts. After you are happy with how a Post looks in Preview, press Publish.
						<div class="seprator_13"></div>
						You can add to, or edit a Post at any time; it will automatically update. Press Hide if you want to remove a Post from your Showcase for a while.
					</div>
					<div class="clear"></div>
