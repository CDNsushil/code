		...
		<div class="row" id="CG<?php echo $i;?>">
			...
			<div id="CGData<?php echo $i;?>" class="cell frm_element_wrapper extract_content_bg">
				...
				<div class="extract_button_box">
					<div  class="small_btn formTip" title="<?php echo $this->lang->line('delete');?>"><a href='javascript:collaborationMediaDelete(<?php echo $data->mediaId;?>,<?php echo $data->fileId;?>)' ><div class="cat_smll_plus_icon"></div></a></div>
