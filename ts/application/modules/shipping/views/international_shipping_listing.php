<?php if (!defined('BASEPATH')) exit('No direct script access allowed');?>
	...
	<div class="c_1">
		<h3 class="red fs21 fnt_mouse  bb_aeaeae">Edit or Delete an International Shipping Zone</h3>
		...
		<ul>
						...
						foreach($interationalShipping as $zone){ ?>
							<li class="mb10 zoneLi"> <span class="bg_f9f9f9 " id="zoneLi_<?php echo $zone['spId'];?>">
								...
								<span class="red pl58 pr5 fs12 fr">
										<a href="javascript:void(0);" onclick="ajaxSave('<?php echo base_url(lang().'/shipping/globalShippingform');?>','#IS_Container','<?php echo $zone['spId'];?>');"> Edit</a> / <a href="javascript:void(0);" onclick="deleteGlobalShipping('<?php echo $zone['spId'];?>');";>Delete </a>
								</span> 
							</li>
							<?php
						}
			...
			<li class="mt36 fl clearb"> 
				<a href="javascript:void(0);">
					<button class="red p10 bdr_a0a0a0 fshel_bold " type="button"  onclick="ajaxSave('<?php echo base_url(lang().'/shipping/globalShippingform');?>','#IS_Container','');" >Add Another Shipping Zone"</button>
				</a> 
			</li>
		</ul>
