...
if(count($currentproductDetail)>0)	{
 ...
 <!--Middle_column-->
        <div class="cell width_476 sub_col_1 pr10 pl10 bg_DarkBlue">
          <div class="seprator_10"></div>
					 ...
					 <div class="Work_gredient_box pt13 pl20 pr11 pb20">
						...
						<?php if(!empty($currentproductDetail->productUrl)){ //for free poduct only ?>
						<div class="seprator_10"></div>
         ...
         <div class="scroll_box darkGrey_bg pt7 pb7 bdr_d2d2d2">
            <div class="row">				
				...
				<?php }
				$userInfo = showCaseUserDetails(@$currentproductDetail->tdsUid);
				//$selectworkType = ($currentWorkDetail['workExperiece']=='t') ?'Experience Wanted' :$currentWorkDetail['workType'] ;
				$applyButton = '';
				if(@$currentproductDetail->catId==1){
      ...
      <?php echo Modules::run("mediafrontend/getReviewList",$productEntityId,$defaultproductId,0,0); ?> 
     ...
     </td><td class="bg_DarkBlue" valign="top">
		 ...
		 <div class="row summery_right_archive_wrapper">
		  ...
		  <div class="clear seprator_10"></div> 
		 	<div class="sumRtnew_strip clr_white height_32"><?php echo $productType ?> </div>
          <div class="clear seprator_10"></div> 
        ...
        <div class="cell width_284 pl10 pr10 sub_col_2 bg_DarkBlue">
          <div class="mt10"></div>
          <!--right btn-->
          <div class="scroll_box darkGrey_bg global_shadow pt15 pb15 bdr_d2d2d2 pl10 pr10">
            <?php
            ...
            <div class="ml20 mr20 mt25">
              ...
              <?php if(!empty($currentproductDetail->productCity) || !empty($currentproductDetail->productCountryId)){ ?>
               ...
               <?php } ?>
                 ...
                 <?php } ?>
                 <?php if(!empty($currentproductDetail->productwillingToPay) && (@$currentproductDetail->catId==2)){ ?>
...
<?php if(!empty($applyButton)) {
	$this->load->view('product_offer_view',array('title'=>@$currentproductDetail->productTitle,'isWorkProfile'=>$workProfileId,'productId'=>$currentproductDetail->productId,'ownerId'=>$currentproductDetail->tdsUid,'btnLabel'=>$applyButton));?>		  
<?php }     
