 ...
 <div class="seprator_10"></div>
  <div class="scroll_box mt10 darkGrey_bg global_shadow bdr_d2d2d2">
            ...
            <div class="slider scroll_light_btn" id="slider1"> <a href="#" class="buttons prev mr12 disable"></a>
              <div class="viewport WorkS_scroll_container">
				...
				<?php
				   ...
				   // $popup_images=$this->load->view('popup_images',$popup_images, true);
					...
					{															
					//echo '<pre />promoImagesDetail';print_r($promoImagesDetail);
					echo $openLi;
					if($promoImagesDetail['noMedia']==1) $maxHW = 'max_w84_h84 p10';//when no media found
					else $maxHW = 'max_w202_h110';
                ?>  
                  <a class="ptr" onclick="openLightBox('popupBoxWp','popup_box','/productshowcase/popupimages','<?php echo $promoImagesDetail['prodId'];?>','<?php echo $count_promo_images;?>',<?php echo $catId;?>);">
                    <div class="row position_relative Work_recent_box_wrapper">
                      ...
                      <div class="ml190 pr10">
                        ...
                        <div class="line1"></div>
                        <div class="pt5 minHeight60px"><?php echo changeToUrl(getSubString($promoImagesDetail['mediaDescription'],85));?></div>
                       
                        <a class="Fright orange_color mt_minus11 gray_clr_hover" onclick="openLightBox('popupBoxWp','popup_box','/productshowcase/popupimages','<?php echo $promoImagesDetail['prodId'];?>','<?php echo $count_promo_images;?>',<?php echo $catId;?>);">View</a> </div>
                      <div class="clear"></div>
                    </div>
                  </a>
                 <?
              ...
              <a href="#" class="buttons next mr12"></a> 
              </div>
