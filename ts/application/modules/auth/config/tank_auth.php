...
|--------------------------------------------------------------------------
*/
$config['website_name'] = 'Toadsquare';
//$config['webmaster_email'] = 'noreply@toadsquare.com';
$config['webmaster_email'] = 'info@cdnsol.com';
...
| 'email_activation_expire' = Time before users who don't activate their account getting deleted from database. Default is 7 days (60*60*24*7).
...
$config['email_activation_expire'] = '7 days';
...
$config['login_attempt_expire'] = 60*2;
...
|--------------------------------------------------------------------------
*/
$config['forgot_password_expire'] = 3600*24*7;
