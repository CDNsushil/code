	...
	<div class="toggle_btn"></div>
	  ...
	  <div class="blog_box">
		<div class="cell blog_left_wrapper">
		  ...
		  <div class="row">
			<div class="cell padding_top10"> <b class="orange_color">Created on:</b> <b> &nbsp; <?php echo date("l, d F Y", strtotime($row->dateCreated));?> </b> </div>
		  </div>
		  ...
		  <div class="row"> <b class="orange_color"><?php echo $label['blogOneLineDesc'];?></b>
			...
			<p>
			<?php 
			if(strlen($row->blogTagWords)>120)
		  ...
		  <div class="row blog_links_wrapper">
			<?php				
				...
				$relation = array('getFrontShortLink','email','share','entityTitle'=> addslashes($row->blogTitle), 'shareType'=>$label['posts'], 'shareLink'=> $currentUrl, 'id'=> 'blog'.$row->blogId);
