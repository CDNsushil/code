...
<div class="content display_table  TabbedPanelsContent width635 m_auto">
    <?php   
    echo form_open($baseUrl.'/setaboutsectiondetails/',$formAttributes); 
    ?>
    ...
    <?php echo form_close();?>
        ...
        <?php 
        // set back page
        $data['backPage'] = '/showcase/showcasedetails';
        // set next form name
    ...
    $(document).ready(function() {
        $("#aboutSectionForm").validate({
            submitHandler: function() {
                ...
                $.post('<?php echo $baseUrl.'/setaboutsectiondetails';?>',fromData, function(data) {
                    if(data){
