...
echo '<div id="News-No-Records">';
echo $label['clickHere'].$label['associateElements'].anchor('javascript://void(0);', $label['NEWS'],array('class'=>'formTip','title'=>$label['NEWS'],'onclick'=>'showRelatedForm(\'NEWSForm-Content-Box\',\'News-No-Records\');'));
echo '</div>';
echo '<div class="row heightSpacer"> &nbsp;</div>';
}
?>
