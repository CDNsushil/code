...
class model_player extends CI_Model {
	...
	*/
	...
	function paidVideoDataByProjectId($projectId,$userId)
	{
		$entityId = "54";
	...
	function getElementPaidStatus($elementId)
	{
		...
		$this->db->select('FvElement.isPerViewPrice,MediaEelementType.default');	
	...
	function getEMElementPaidStatus($elementId)
	{
		...
		$this->db->select('EmElement.isPerViewPrice,MediaEelementType.default');	
