...
class getMedia{
	...
	* */
	...
	/************ This code for detecting Os then play video**************/
		
		
			// This condition check Mobile Os
			...
			if(getOsName()=="mobile")
			{
					...
					<link href="'.base_url().'player/html5_video_player/video-js.css" rel="stylesheet" type="text/css">
					  <!-- video.js must be in the <head> for older IEs to work. -->
					  <script src="'.base_url().'player/html5_video_player/video.js"></script>
					  ...
					  <script>
						...
						$(document).ready(function() {
						 ...
						 $("#example_video_1").addClass("html5_video_show");
					...
					<video id="example_video_1" class="video-js vjs-default-skin" controls preload="none" 
     					...
     					<source src="'.base_url().'player/html5_video_player/secure/'.rand().'/'.time().'/'.base64_encode($this->filePath.'/'.$this->fileName).'" type="video/mp4">
						<p>Video Playback Not Supported</p>
					</video>';
			}else
			{
				// This player for desktop os
	...
	static function playAudioPlaylist(){
