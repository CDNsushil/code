...
<div class="popup_gredient ">
 ...
 <?php
	echo form_open('help/request_sub_cat/', 'class="form" id="requestCategory" name="requestCategory"'); 
	?>
  ...
  <!-- row01-->
    	...
    	<div class="row">
            <div class="contact_label_subcate_popup_new_post_request cell" >
              <label class="select_field labe_aerow"><?php echo $this->lang->line('Category'); ?></label>
            </div>
            <div class="cell contact_frm_element_wrapper width_405 ml-17">
    ...
    <div class="row wordcounter" id="word_counter">
		    <span class="tag_word_orange clr_666 font_size11 ml185 mt4 orange_clr_imp"><?php echo $this->lang->line('5_50words');?></span>
    </div>
    <div class="clear"></div>
