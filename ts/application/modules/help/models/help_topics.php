...
class Help_topics extends CI_Model {
	...
	public function get_topics($limit, $offset=NULL)
	{
		...
		$this->db->join('UserShowcase', 'UserShowcase.tdsUid = UserAuth.tdsUid');
       	...
       	//$options = array('forum_topics.Active'=>'1','forum_category.type' => 'help','forum_category.Active' => '1'); // Only get active topics
	...
	*/		
	...
	public function submit_topic() 
	{
    	...
    	redirect('help/posts/'.$this->input->post('category').'/'.$TopicID.'/');
		}
	} // End of submitTopic
