...
<?php 	
//Common Banner
	$topCravedArray = array('entityId'=>$projectEntityId,'projectType'=>'writingNpublishing');
	$topCravedElementArray = array('entityId'=>84,'projectType'=>'writingNpublishing');
	$topCravedData['defaultProfileImage'] = $this->config->item('writingNpublishingImage_m');	
	...
	if(is_array($topCravedData['data']) && count($topCravedData['data'])>0)		
		$topCravedHtml = $this->load->view('common/top_craved_writingnpublishing',$topCravedData,true);
	else
		$topCravedHtml = '';
	
	$bannerarray['imgarray']=array('banner_front_writing-and-publishing_get-your-writing_HR.jpg','banner_front_writing-and-publishing_find-blockbuster_HR.jpg');
	...
	if(!empty($reviews_array) || !empty($news_array)){	
?>
          ...
          <div class="row">
			...
			$newsReview['main_div_class'] =  "cell bdr_brown10 global_shadow bg_white ml40 width_420";
			...
			$newsReview['slider1_main_class'] =  "slider wp_news_scroll_btn_box";
			$newsReview['slider2_main_class'] =  "slider wp_news_scroll_btn_box";
            ...
            <div class="cell">
              ...
              <div class="bdr_brown10 global_shadow bg_white <?php echo $mlClass; ?> width_420">
                <div class="wp_project_heading ml11"><?php echo $this->lang->line('LatestProjects');?></div>
                <div class="seprator_3"></div>
                <div id="slider3" class="slider wp_project_scroll_btn_box mt_minus30">
                  ...
                  <div class="viewport wp_project_scroll_container ml10">
                    <ul class="overview">
                       <?php
						...
						$recordDetailUrl = base_url(lang().'/mediafrontend/searchresult/'.$projDetail->tdsUid.'/'.$projDetail->projId.'/writingpublishing');		
						
						$projUserInfo = showCaseUserDetails($projDetail->tdsUid);
													
						//$thumbFinalImg = getImage(@$projDetail->projBaseImgPath,$this->config->item('writingNpublishingImage_s'));
						$thumbImage = addThumbFolder(@$projDetail->projBaseImgPath,'_s');				
						$thumbFinalImg = getImage(@$thumbImage,$this->config->item('writingNpublishingImage_s'));
			  ...
			  ?>
              <div class="bdr_brown10 global_shadow bg_white <?php echo $mlClass; ?> width_420">
                <div class="wp_project_heading ml11"><?php echo $this->lang->line('LatestUpcomingProjects');?></div>
                <div class="seprator_3"></div>
                <div id="slider4" class="slider wp_project_scroll_btn_box mt_minus30">
				<div class="position_relative">
                	<div class="z_index_2 position_relative">
                 		<a href="#" class="buttons next"></a><a href="#" class="buttons prev mr3 disable"></a>
                 	</div>
                  ...
                  <div class="viewport wp_project_scroll_container ml10">
                    <ul class="overview">
						...
						$upcomingDetailUrl = base_url(lang().'/upcomingfrontend/viewproject/'.$upcomingDetail['tdsUid'].'/'.$upcomingDetail['projId'].'/writingpublishing');	
