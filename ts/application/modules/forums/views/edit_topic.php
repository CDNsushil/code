...
echo form_open('forums/update_topic', 'class="form"');
?>

<div class="seprator_14"></div>
  <div class="bdr_d2d2d2 Contact_form_topbox">
  
  <div class=" font_opensans font_size18 clr_666 pt5 pl15 lineH_30"><?php echo $this->lang->line('EditDiscussion');?></div>
  <div class="seprator_7"></div>
  <div class="position_relative pb20">
...
<ul class="ul_relative">
    ...
    <div class="">
		...
		<label class="select_field_topic"> &nbsp; </label>
	</div>	
	...
	if($this->ion_auth->logged_in())
	{
		...
		echo '<li><div class="Req_fld cell">'.$this->lang->line('RequiredFields').'</div>  <div class="tds-button fr"><button onclick="submitform();" onmousedown="mousedown_tds_button(this)" onmouseup="mouseup_tds_button(this)" type="submit" value="Save" name="save"><span class="text-indent_0">Update Discussion</span></button></div>';
