...
echo form_open('forums/submit_topic', 'class="form"');
...
<div class="seprator_14"></div>
  ...
  <!-- row01-->
        ...
        <div class="row">
            ...
            <div class="cell contact_frm_element_wrapper width_250">
            <?php 
            echo form_dropdown('category', $category_options, $catego_id, 'class="width250px "'); ?> 
...
<script>
setSeletedValueOnDropDown(selectBoxid, value)
</script>
