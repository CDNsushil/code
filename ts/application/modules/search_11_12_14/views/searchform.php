	  ...
	  <div class="search_left_box mt6 ml9 mb6 mr10">
		...
		<div class="SRleft_select_box ml1 mt0">
		 ...
		 <div id="townCity" class="dn">
			<div class="search_page_input ml3 "><input name="city" type="text" placeholder="<?php echo $this->lang->line('city');?>" onclick="placeHoderHideShow(this,'<?php echo $this->lang->line('city');?>','hide')" onblur="placeHoderHideShow(this,'<?php echo $this->lang->line('city');?>','show')" value="" /></div>
