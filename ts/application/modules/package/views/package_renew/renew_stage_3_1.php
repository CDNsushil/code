...
<?php echo form_open($this->uri->uri_string(),$renewStage3_1); ?>
                   ...
                   <div class="TabbedPanelsContent TabbedPanelsContentVisible">
                      <div class="wra_head clearb">
                        ...
                        <?php 
                          ...
                          $data['backUrl']    =  base_url('package/renewstagetwo');
...
<script>
  ...
  $("#renewStage3_1").validate({
    ...
    submitHandler: function() {
      var formPostUrl = "/package/renewbillingdetailspost";
      var formData =$("#renewStage3_1").serialize();
      $.ajax({
      type: 'POST',
