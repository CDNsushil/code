    ...
    echo form_open($this->uri->uri_string(),$formAttributes);
        ...
        <div class="fl  clearb mt10 dn hs" section_name="date" section="<?php echo $dateSections;?>" >
            <div class="to_wrap fl clearbox position_relative">
                ...
                <input class="datepicker hasDatepicker" id="eventStartDate" name="eventStartDate" type="text" disabled="disabled" placeholder="<?php echo date('F : Y');?>" value=""><button type="button" class="ui-datepicker-trigger" onclick='$("#eventStartDate").focus();'>...</button>
            </div>
            <div class="frm_wrap  clearbox position_relative fl mt8">
                <label class="pl7 width_50 pt7 fl" for="to">To</label>
                <input class="datepicker hasDatepicker" id="eventEndDate" name="eventEndDate" type="text" disabled="disabled" placeholder="<?php echo date('F : Y');?>" value=""><button id="eventEndDateCal" type="button" class="ui-datepicker-trigger" onclick="$('#eventEndDate').focus();">...</button>
            </div>
        </div>
        ...
        <ul class="clearb mt10 select_shadow defaultP bdr_a1a1a1 clr_666 fs13 width_235 p10 pb0 select_list " section_name="sectionId"  >
            ...
            if(is_array($sectionList) && !empty($sectionList)){
                foreach($sectionList as $sectionId=>$section){ 
                    ...
                    <li>
                        <label>
                            <input <?php echo $checked;?> type="radio" name="sectionId" class="sectionId" value="<?php echo $sectionId;?>" ><?php echo $section;?>
                         </label>
                    </li>
                    <?php
                }
            ...
            if(is_array($showcase_section) && !empty($showcase_section)){
                foreach($showcase_section as $sectionId=>$part){ 
                    ...
                    if(is_array($part)){?>
                        ...
                        <li>
                            <label>
                                <input <?php echo $checked;?> type="radio" name="projectPart" class="sectionId" value="<?php echo $sectionId;?>" ><?php echo $part;?>
                             </label>
                        </li><?php
                    }
                }
        ...
        <?php
            ...
            if(is_array($media_section) && !empty($media_section)){
                foreach($media_section as $sectionId=>$part){ 
                    ...
                    <li>
                        <label>
                            <input <?php echo $checked;?> type="radio" name="sectionId2" class="sectionId" value="<?php echo $sectionId;?>" not_in_section="type|industry" ><?php echo $part;?>
                         </label>
                    </li>
                   <?php
                }
            ...
            if(is_array($fv_section) && !empty($fv_section)){
                foreach($fv_section as $sectionId=>$part){ 
                    ...
                    if(is_array($part)){?>
                        ...
                        <li>
                            <label>
                                <input <?php echo $checked;?> type="radio" name="projectPart" class="sectionId" value="<?php echo $sectionId;?>" not_in_section="type" ><?php echo $part;?>
                             </label>
                        </li><?php
                    }
                }
            ...
            if(is_array($em_section) && !empty($em_section)){
                foreach($em_section as $sectionId=>$part){ 
                    ...
                    if(is_array($part)){?>
                        ...
                        <li>
                            <label>
                                <input <?php echo $checked;?> type="radio" name="projectPart" class="sectionId" value="<?php echo $sectionId;?>" not_in_section="industry" ><?php echo $part;?>
                             </label>
                        </li><?php
                    }
                }
                ...
                foreach($event_section as $sectionId=>$part){ 
                    ...
                    if(is_array($part)){?>
                        ...
                        if(!empty($part))foreach($part as $partId=>$projectPart){ ?>
                            <li>
                                <label>
                                    <input type="radio" name="projectPart" class="sectionId" value="<?php echo $partId;?>"  ><?php echo $projectPart;?>
                                 </label>
                            </li><?php
                        }
                    }else{ ?>
        ...
        <ul class="clearb mt10 memberform select_shadow defaultP bdr_a1a1a1 clr_666 fs13 width_235 p10 pb5 select_list dn hs" section_name="industry" section="<?php echo $industrySections;?>">
            ...
            if(is_array($showcase_industry) && !empty($showcase_industry)){
                foreach($showcase_industry as $industryId=>$industry){ 
                    $checked = (is_numeric($industryId) && $industryId == 0)?'checked':''; ?>
                    <li>
                        <label>
                            <input <?php echo $checked;?> type="radio" name="industryId" class="industryId" value="<?php echo $industryId;?>" ><?php echo $industry;?>
                         </label>
                    </li>
                    <?php
                }
        ...
        <?php $industrySections='|'.$this->config->item('performancesneventsSectionId').'+upcomingprojects|';?>
        <ul class="clearb mt10 memberform select_shadow defaultP bdr_a1a1a1 clr_666 fs13 width_235 p10 pb5 select_list dn hs" section_name="industry" section="<?php echo $industrySections;?>">
            <li class=" pb12 red bd_none font_bold ml30">Events For</li>
            <?php
