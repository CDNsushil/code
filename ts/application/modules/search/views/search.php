<div class="sidebar_box ml22">
    <!--<div class="sidebar_heading"><h3><?php //echo $this->lang->line('searchTitle'); ?></h3></div>-->
       <div id="search">
            ...
            <form method="post" id="searchform" action="<?php echo ''.site_url().'en/forums/search'; ?>">
                <fieldset class="search">
                <!-- <input name="search" type="text"  class="search_text_box width_142" PLACEHOLDER="Keyword Search..." />--->
               <input class="search_text_box" type="text" onblur="placeHoderHideShow(this,'Search Forum...','show')" onclick="placeHoderHideShow(this,'Search Forum...','hide')" value="Search Forum..." placeholder="Search Forum..." name="search">
