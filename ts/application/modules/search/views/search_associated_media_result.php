    ...
    if($searchResult && is_array($searchResult) && $searchResultCount > 0) { 
        foreach($searchResult as $k=>$search) {
            ...
            if(((!empty($sectionId) &&  $sectionId=='media') || isset($prosectionId)) && $fromSection!='abuseReport') {
                ...
                <div class="section">
                    <div class="fl">
                        <input type="radio"  name="associatedElementId" value="<?php echo $elementid;?>" rel="<?php echo $elementid;?>" projectid="<?php echo $projectid;?>" entityid="<?php echo $entityid;?>" SupportingProjectName="<?php echo $title;?>" createrid="<?php echo $createrid;?>" onclick="recordSelected(this)" >
                    </div>
                       ...
                       <div class=" display_table list_thumb">
                        ...
                        <div class="head_list fr pl15 width_478 bb_F1592A pb4 lineH15 mb6">
                            ...
                            <span class="fr text_alignR ">
                                ...
                                <?php echo string_decode($search->title); ?>
                            </span>
                        </div>
