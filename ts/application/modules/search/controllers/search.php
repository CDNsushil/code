...
class Search extends MX_Controller{
    ...
    public function searchform_new()
	{
        $cacheFile=$this->dirCacheMedia."advance_search_form.html";
        ...
        $this->data['searchform'] =  $this->load->view('advance/searchform',$this->data,true);
		...
		*/
		...
		$this->data['advertSectionId'] = $this->config->item('searchSectionId');
