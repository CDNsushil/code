...
{
	$postMediaGalleryPath = base_url().'media/'.LoginUserDetails('username').'/workshowcase/Audios/'.$recordSet->mediaName;
...
$urlVariable= 0;
$attributes = array('name' => 'myForm', 'id' => 'addMoreAudios');

echo form_open_multipart('workprofile/workshowcase/addMoreAudios/'.$urlVariable,$attributes);?>
...
function calcelForm()
	{
		location.href=baseUrl+language+"/workprofile/workshowcase/showWorkShowcaseAudios";
	}
function submitform()
{
