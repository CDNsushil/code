<?php echo form_open('workProfile/workshowcase/deleteMedia',"name='mediaForm'");
			...
			echo form_hidden('mediaType','Images');
// echo $WorkProfileId ;?>
...
<div class="row summery_post_wrapper">
	...
	<div class="tds-button floatRight" ></div>
	<div class="frm_wp">
		...
		?>
			<div class="all_list_item ">
				<div class="pb10" style="min-height:85px">
					...
					<?php
							$writtenMaterialPath ='media/'.LoginUserDetails('username').'/workshowcase/Images/'.$row['mediaName'];
								...
								<div class="title-content-left">
									<div class="title-content-right">
										<div class="title-content-center">
											...
											<?php
												//History Edit Icon
												echo anchor('workProfile/workshowcase/addMoreImages/'.$row['mediaId'], '<span><div class="projectEditIcon"></div></span>');	
												//History Delete Icon
