...
?>
 ...
 <button type="button" class="rating_1 <?php echo ($isPublished=='t')?'rateAction'.$entityId.$elementId:''; ?>  rateBtn<?php echo $entityId.$elementId?>  ptr button_c fs11 <?php echo $rateAll ?>" >
