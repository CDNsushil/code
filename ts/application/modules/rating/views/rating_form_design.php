...
<div id="ratingBlock"  class="poup_bx">
  
   <div class="close_btn position_absolute " onclick="$(this).parent().trigger('close');"></div>
   <h3 class="red fs21  text_alighC pb19">Rate</h3>
   <div class="bdrb_afafaf "></div>
   <div class="rate_empty clearb">
      <div id="imgMask"><img src="<?php echo $imgPath; ?>rating_mask.png" /></div>
      <div id="ratingBoxDiv">
         <div id="fillLayer"></div>
      </div>
   </div>
   <div class="rate_bar clearb ">
      <div id="ratingBar">
         <div id="baseBarDiv"></div>
         <div id="draggerDiv"  style="left:39px;"></div>
      </div>
   </div>
   <div class="seprator_10"></div> 
   <button type="button" onclick="javascript:postRating('ratingBlock','<?php echo $entityId;?>','<?php echo $elementId;?>','<?php echo $this->lang->line('alreadyRate');?>','<?php echo $this->lang->line('beforeRatingLoggedIn');?>');" >Rate</button>
   <div class="clear"></div>
</div>
