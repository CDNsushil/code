<div class="contentcontainer">
				...
				<tr>
					<th>
						<?php 
							...
							{
							  echo "<a href='".BASEURL."admin_mail/nonqualified_members_list/".$user["value"]."' class='tooltipClass' title='".$this->lang->line('admin_search_by_user')." ".$user['value']."'>".$user["value"]."</a> | ";
							}
						?>
					</th>
				</tr>
	...
	<form name="mail_form" id="mail_form" method="post" action="<?php echo $action?>" onSubmit="return valid_mailing();">
		...
		<input type="hidden" name="user_type" id="user_type" value="NQ" >
