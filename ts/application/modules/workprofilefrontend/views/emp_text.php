      ...
      <table cellspacing="0" cellpadding="0" border="0">
        <tr>
          ...
          <div class="position_relative minh_1125">
			 ...
			 <?php  if(isset($profileText) && count($profileText) > 0) { ?>
			
				<?php  if(isset($profileText) && count($profileText) > 1) { ?>
             ...
             <div id="imageHolder">  
              ...
              <div class="frame_box ml12 mr12 mt20">
                <div class="bg_313131" >
                  <!--video box-->
                  <div class="bg_222222 margin_auto" >
					<div class="AI_table">
						<div class="AI_cell">
						  <div id="imageHolder" class="mH896">
							<div id="imageDiv" style="height:896px;">
								<iframe src="" width="750" height="896"  webkitAllowFullScreen mozallowfullscreen allowFullScreen scrolling="no" style="margin:0; padding:0; border:0px solid #CC00DD;"></iframe> 	
							</div>
							<div id="loaderDiv"  class="mediaLoadDiv pt340"><img src="<?php echo  base_url().'images/'; ?>loading_wbg.gif"></div>
            ...
            <?php } ?>
              ...
              <ul id="imageList" class="hidden">
			   ...
			   if(isset($profileText)) {
			    foreach($profileText as $text) { ?>        
				<li onclick="javascript:loadMe(this)" targetpath="<?php echo base_url()?>en/player/getPlayerIframe/<?php echo $text->fileId.'_full/'.$entityId.'/'.$text->workProfileId.'/'.$text->workProfileId; ?>"> 
					<img src="images/video01.jpg" /> 
					 <div class="description hidden">
						<p>
							<?php echo nl2br($text->mediaDesc); ?>
						</p>
					</div>
					
					<div class="title hidden">
             	       <?php echo $text->mediaTitle ?>
                   </div>					
			...
			{?>
				...
				<li onclick="javascript:loadMe(this)" targetpath="<?php echo base_url()?>en/player/videoError">  
