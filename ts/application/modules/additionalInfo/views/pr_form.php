        ...
        <div class="link_2 <?php echo $mt40;?>">
            <ul class="public">
                ...
                <li>
                    ...
                    <textarea class="bdr_adadad width612 mt10 required" name="title" id="title" value="" placeholder="Ttile" onclick="placeHoderHideShow(this,'Ttile','hide')" onblur="placeHoderHideShow(this,'Ttile','show')" wordlength="1,15" onkeyup="checkWordLen(this,'15','wordsLimit')"></textarea>
                </li>
            </ul>
