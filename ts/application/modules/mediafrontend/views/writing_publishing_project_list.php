...
if(!empty($projectListingData)) {
        ...
        foreach($projectListingData as $projectData){
            ...
            $projectUrl=base_url(lang().'/mediafrontend/writingdetails/'.$frentendUserId.'/'.$projectId);
        ...
        <div class=" border_cacaca display_inline_block mb20">
                    ...
                    <div class="collection_writing_box fl ">
                         <a target="_blank" href="<?php echo $projectUrl; ?>" class="display_table width100_per" >   
                        <span class="table_cell writing_list position_relative zindex9" > <img src="<?php echo $projectImage; ?>" alt=""  /> </span>
                        <div class="display_inline width_545 pt15 fr pr50 mb50">
                           <h4 class="fs16 font_bold lineH20"><?php echo $projName; ?>
                           </h4>
