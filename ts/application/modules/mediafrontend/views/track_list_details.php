<?php if ( ! defined('BASEPATH')) exit('No direct script access allowed');
    ...
    if($currentKeyPosition > 0):
        ...
        $previousPageLink       =     'mediafrontend/tracklist/'.$frentendUserId.'/'.$projectId.'/'.$previousElementId;
    ...
    if($currentKeyPosition < ($elementNumberCount-1)):
        ...
        $nextPageLink       =    'mediafrontend/tracklist/'.$frentendUserId.'/'.$projectId.'/'.$nextElementId;
 ...
 <div class="row content_wrap" >
       ...
       <div class="width903 m_auto pt25 sc_album display_table">
          ...
          <div class="left_w width_302  lineH18 fl mr pr30">
             <div class="head_list fl  bg_fdfdfd bdr_ececec ">
             ...
             <div class="clearb">
                <div class="green fs30 pb15  opens_light bb_e9e9e9"><?php echo $projGenreFree; ?></div>
                <div class="opens_light lineH10 fs16">This is Sub-Genre</div>
             </div>
             ...
             <div class="clearb pl16">
                <p class="red font_bold mt10 "><?php echo $infoDetails; ?> Information</p>
                <ul class="edit_list pb2 fs13 pt15  ">
          ...
          <div class="rightbox width562 position_relative fr">
             <div class="fs20 font_bold lineH23" id="gettracktitle"><?php echo $title;?>
             </div>
             <div class="bb_b7b7b7 sap_20 "></div>
             <div class="sap_35"></div>
             <div class="player_music">
                <div class="Player_profile fl wh_193">
                    <?php 
                ...
                <div class="player_box fl pl20 pr15">
                   <script>
                        var mediaObject = <?php echo json_encode(array('projectId'=>$projectId,'elementId'=>$elementId,'elementEntityId'=>$elementEntityId)); ?>;
                   </script> 
                  
               
                   <p class=" pr10 lineH14 fs13"> <span class="fl font_bold red"> <a href="javascript:void(0)" onclick="addtoplaylist(mediaObject)">Add to Playlist</a></span> <span class="fr"><a href="javascript:void(0)" onclick="openLightBox('popupBoxWp','popup_box','/mediafrontend/albumplaylist','<?php echo $projectId; ?>');">View Track List</a></span> </p>
                  
                   <div class="sap_20"></div>
                    <div class="track pt3">
                       
                       <!--
                       <img src="<?php //echo base_url('/templates/new_version/images') ?>/track.jpg" alt=""  />
                       -->
                        <?php
                   ...
                   <div class="fr ">
                       <?php 
                          ...
                          //$this->load->view('rating/rating_form_design',array('elementId'=>$elementId,'entityId'=>$entityId));
                            ...
                            $this->load->view('media/reviewViewNew',array('elementId'=>$elementId,'entityId'=>$elementEntityId,'projName'=>$title,'section' =>'Music & Audio','industryId' =>'1','isPublished'=>$isPublished));
