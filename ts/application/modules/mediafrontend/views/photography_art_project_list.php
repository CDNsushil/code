...
if(!empty($projectListingData)) {
        ...
        <div class=" border_cacaca display_inline_block mb20">
             <div class="collection_list_box fl ">
                ...
                <div class="display_inline width560 pt5 fl  mb50">
                   <h4 class="fs16 font_bold pb14 lineH20"><?php echo $projName; ?></h4>
                   <div class="fs12 lineH14"> <?php echo $projShortDesc; ?> </div>
                   ...
                   <div class="clearb">
                      <div class="fl"> 
                            ...
                            <?php  } ?>
                            <?php if($printCount > 0){ ?>
                            <span> <b class="red  pr7"><?php echo  $printCount; ?></b>
                                <?php echo $this->lang->line('photographyNart_photo_physical'); ?>
                            </span>
                            <?php  } ?>
                            
                            <?php if($projSellType=="2"){ ?>
                                <span class="pl15 red ">AUCTION</span>
                            <?php } ?>
                            
                            <?php if($projSellstatus=="f"){ ?>
                                <span class="pl15 red ">FREE</span>
                            <?php } ?>
                      </div>
                      <div class="fr fs16">
                         <?php 
                            echo ($projCategory=="7")?$this->lang->line('photographyNart_photo_album'):$this->lang->line('photographyNart_photo_collection');
                          ?>
                      </div>
