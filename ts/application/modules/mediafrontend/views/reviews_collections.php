<?php if ( ! defined('BASEPATH')) exit('No direct script access allowed');
    ...
    $aboutPageLink       =     'mediafrontend/reviewsdetails/'.$frentendUserId.'/'.$projectId;
...
<div class="row content_wrap" >
     <?php
        ...
        $viewData = array(
        'headingName'   =>   $this->lang->line('reviews_detail_heading_'.$categoryId),
   ...
   <div class="width900 m_auto pt24 sc_album display_table">
        ...
        <div id="review_element_list">
            <?php 
            
                //---------review collection element list-----------//
                    $this->load->view('reviews_collections_element_list');
                //---------review collection element list-----------//
            ?>
        </div>
      ...
      <div class="about_review_text">
         ...
         <div class="width562 rightbox  bt_b7b7 fl pt15">
            <div class="clearbox bg6c6c pt20 pb22">
               <h3 class="fs29 pl18 clr_fff lineH24">About the Reviews Collection </h3>
            </div>
