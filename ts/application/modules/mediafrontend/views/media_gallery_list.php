...
<div class="row content_wrap" >
   ...
   <div class="banner_collection gallery_banner pb0" >
      <!--==================  full screen slider  start ============-->
      <div class="width900 display_table m_auto pb30">
         <h2  class="lineH14 fl"><?php echo $title;?> </h2>
         ...
         <hr class="bb_ececec width100_per clearb"  />
      </div>
      <!--==================  banner start ============-->
      <div class=" bg_444 display_table">
         <div class="width_890 pt25 pb14 display_table m_auto">
            <div class="fr pr10">		
               ...
               <div class="table_cell height500 "> 
                    ...
                    <?php
                        ...
                        /*************Here check exnternal and interter media**************/ 
                            ...
                            if($isvalidUrl)   {    ?> 
                                <iframe src="<?php echo $getSrc; ?>" width="898" height="500" frameborder="0"  webkitAllowFullScreen mozallowfullscreen allowFullScreen scrolling="no"></iframe>
                                <?php } else { 
        ...
        <div class="display_table width900 m_auto pt23 pb27">			
             <a class="btn_review mr5 fs16  clr_fff lineH18 " href="<?php echo $moreAboutVideLink; ?>"><?php echo $this->lang->line('filmNvideo_more_about_this_1'); ?> <?php echo $elementMediaType; ?></a>
        </div>
      </div>
      <!--================== thumnail  slider  start ============--> 
   </div>
   <div class="width900 pb20 display_table m_auto sc_album">
      ...
      <?php if(!empty($trailerSampleElementList)){ 
        ...
        ?>
          <a href="<?php echo $elementUrl; ?>">
              <span class="position_relative bdr_c3c3c3 <?php echo $elementTypeClass; ?>  display_table  fl <?php echo ($videoCount>1)?'ml18':''; ?> ">
      ...
      <div class="fr mr-17 left_collection">
         <div class="fl pr20">
           <!--
            <span class="lettsp-1 pb15">Collection Contents</span>
            <br>
            <span>
            <b class="red pr7">12</b>
            Video Files
            </span>
            <span class="pl10">
            <b class="red pr7">2</b>
             ...
             <li>
                <div class="table_cell">
                   ...
                   <div class="thum_text box_onbanner" onclick="window.location.href='<?php echo $elementUrl; ?>'">
                      ...
                      <a href="<?php echo $aboutMore; ?>" class="fshel_light fs16"><span><?php echo $this->lang->line('filmNvideo_more_about_this'); ?> <?php echo $getElementFileType; ?></span></a> 
                   </div>
                </div>
            </li>
        <?php 
