<?php if ( ! defined('BASEPATH')) exit('No direct script access allowed');
    ...
    if($currentKeyPosition > 0):
        ...
        $previousPageLink       =     'mediafrontend/educationdetails/'.$frentendUserId.'/'.$previousProjectId;
    ...
    if($currentKeyPosition < ($projectsNumberCount-1)):
        ...
        $nextPageLink       =    'mediafrontend/educationdetails/'.$frentendUserId.'/'.$nextProjectId;
         ...
         <div class=" cnt">
            ...
            <div class="fr">
                <?php 
                    ...
                    $this->load->view('media/reviewViewNew',array('elementId'=>$projectId,'entityId'=>$entityId,'projName'=>$projName,'section' =>'Creative-Industry Educational','industryId' =>$projectindustryid,'isPublished'=>$isPublished));	
                ?>
            </div>
