<?php if ( ! defined('BASEPATH')) exit('No direct script access allowed');
    ...
    $aboutPageLink       =     'mediafrontend/reviewscollection/'.$frentendUserId.'/'.$projectId;
      ...
      <div class="about_review_text">
         <div class="fl width_325 pr27">
            ...
            <div class="clearb pl16">
               <b class="red lettsp-1"> Reviews Information</b>
         ...
         <div class="width562 rightbox   fl">
            <div class="bg_f6f5f4 bt_b7b7 bb_b7b7b7 news_wrap mb8 pb15 pt15 pr15 pl15">
