<?php if ( ! defined('BASEPATH')) exit('No direct script access allowed');
    ...
    if($currentKeyPosition > 0):
        ...
        $previousPageLink       =     'mediafrontend/photoartelement/'.$frentendUserId.'/'.$projectId.'/'.$previousElementId;
    ...
    if($currentKeyPosition < ($elementNumberCount-1)):
        ...
        $nextPageLink       =    'mediafrontend/photoartelement/'.$frentendUserId.'/'.$projectId.'/'.$nextElementId;
     ...
     <div class="fr">
        <?php 
          ...
          //$this->load->view('rating/rating_form_design',array('elementId'=>$elementId,'entityId'=>$entityId));
            ...
            $this->load->view('media/reviewViewNew',array('elementId'=>$elementId,'entityId'=>$elementEntityId,'projName'=>$title,'section' =>'Photography & Art','industryId' =>'1','isPublished'=>$isPublished));
