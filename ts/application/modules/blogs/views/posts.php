...
if(!isset($userId)|| $userId=='')$userId = LoginUserDetails('user_id');
?>
<div class="seprator_10"></div>
<div id="pagingContent" class="sub_col_middle">
<?php
		if($totalRecords > 0)
		{	
			$flag =0;
				...
				<div class="all_list_item ">
					...
					$finalSmallImg = getImage($smallImg,$this->config->item('defaultPostImg_s'));
					...
					<div class="cell summery_post_description">
						...
						<div class="industry_type_wrapper padding_0">
							...
							<div class="row readmore" >
								<?php
									echo anchor('blogshowcase/frontPostDetail/'.$userId.'/'.$row->postId,'Read More ......');
								?>								
							</div>
