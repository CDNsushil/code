...
<div class="Banner_box_wp_new">
            <ul id="wp_banner_slider">
              <li><img src="<?php echo base_url();?>images/frontend/banners/banner_front_end06.jpg"/></li>
              <li><img src="<?php echo base_url();?>images/frontend/banners/banner_front_end05.jpg"/></li>
              <li><img src="<?php echo base_url();?>images/frontend/banners/banner_front_end04.jpg"/></li>
              <li><img src="<?php echo base_url();?>images/frontend/banners/banner_front_end03.jpg"/></li>
