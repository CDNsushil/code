...
?>
	...
	<div class="row">
		...
		<div class=" cell frm_element_wrapper NIC">
			...
			<div id="myInstance3"  class="editordiv formTip" title="<?php echo $this->lang->line('productDescription');?>">
			...
			<?php echo isset($errors[$productDescriptionArr['name']])?$errors[$productDescriptionArr['name']]:''; ?>	
				<div id="DescError" class="dn" ></div><?php echo form_error($productDescriptionArr['name']); ?></div>	
...
<script type="text/javascript">
	/*$('#myInstance3').bind('keyup', function() {
	var divContent = $.trim($('#myInstance3').text());	
	$('#productDescription').html(divContent);	
