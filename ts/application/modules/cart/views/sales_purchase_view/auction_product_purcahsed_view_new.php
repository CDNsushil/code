 ...
 <div class="sale_box shadow_light">
    ...
    <div class="half_box_second  verti_top">
      ...
      <?php
       ...
       <div  class="lett_8p lineH14">View until <b class="red date_sale"><?php echo $productUseData; ?></b> <b class="time"><?php echo $productUseTime; ?></b>  <span class="fs12">Luxembourg Time</span></div>
       <div class="sap_20"></div>
       <button class="fr bg_f1592a bdr_aca ml15 height32" >
       <span class="download_file pr20 comming_soon">Download All</span></button>
       <button class="fr mr0 view_btn view_all mt0 comming_soon" role="button" >View All</button>
    </div>
 </div>
