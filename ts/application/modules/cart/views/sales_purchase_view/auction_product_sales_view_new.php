...
<div class="sale_box shadow_light">
    ...
    <div class="half_box verti_top">
       ...
       <div class="sale_btnwrap">
          ...
          <button class="light_btn " type="button">Buyer’s Comment</button>
       </div>
    </div>
    <!-- Half box gary  --> 
    <div class="half_box_second  verti_top">
       ...
       <div  class="lettsp3 lineH14"> Per View until <b class="red date_sale"><?php echo $productUseData; ?></b> <b class="time"><?php echo $productUseTime; ?></b>  Luxembourg Time</div>
