...
<div class="row content_wrap blog_wrap" >
   <div class="bg_f1f1f1 fl width100_per  title_head">
      ...
      <div class=" fl fs16 pt15">
         <ul class="cart_nav">
            <li class="<?php echo ($currencySelected=='euro')?'active':''; ?>"><a href="<?php echo base_url_lang('cart/mywishlist/euro'); ?>"><span class="cart_icon">&euro;</span>EURO Cart</a></li>
            <li class="<?php echo ($currencySelected=='dollar')?'active':''; ?>"><a href="<?php echo base_url_lang('cart/mywishlist/dollar'); ?>"><span class="cart_icon">$</span>USD Cart</a> </li>
         </ul>
      </div>
        <?php 
