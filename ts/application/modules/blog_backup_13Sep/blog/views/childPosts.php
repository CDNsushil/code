...
<div class="row summery_post_wrapper">
 ...
 <div class="cell width_480 sub_col_1">
			...
			<div id="frontPostsInfo">
				<div class="row post_sample_heading formTip" title="<?php echo $parentPost['postResults'][0]->postTitle;?>">					
					<?php 
						...
						if(strlen($parentPost['postResults'][0]->postTitle)>60)
							$restrictedPostTitle = substr($parentPost['postResults'][0]->postTitle,0,60).'...';
						else
								...
								<div class="all_list_item ">
									...
									<div class="cell summery_post_description">
										...
										<div class="industry_type_wrapper padding_0">
											...
											<div class="row ">
												<?php if(strlen($row->postOneLineDesc)>130)
	...
	<?php
		echo Modules::run("blog/frontRight",$blogId);
	?>
</div>
