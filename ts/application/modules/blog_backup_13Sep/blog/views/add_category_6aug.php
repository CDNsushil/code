...
<div class="row" id="categoryDiv">
	<div class="label_wrapper cell"><label><?php echo $this->lang->line('category');?></label></div>
	<!--label_wrapper-->
		...
		<div class="cell frm_element_wrapper">
				...
				<div class="cell cat_btn ml5">
					...
					<?php
							...
							echo anchor('javascript://void(0);','<span><div id="addCatButton" class="cat_plus_icon"></div></span>',array('class'=>'formTip go fl',
							'title'=>$this->lang->line('save').' '.$this->lang->line('categories'),
...
<script type="text/javascript">	
	...
	function catCancel()
	{
			...
			if($('#addCatButton').hasClass('cat_edit_icon'))
			{
