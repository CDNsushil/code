	...
	<div class="TabbedPanelsContent Consumption_Tax TabbedPanelsContentVisible">
		<?php echo form_open('dashboard/saveConsumptionTax',$formAttributes);?>  
			<div class="c_1 ">
				...
				<div class=" width_520 m_auto defaultP mb20">
				...
				<ul class="mt35">
					<li class="icon_1 red">
						<?php echo $this->lang->line('allSaleUpdate');?>
					</li>
				</ul>
				<div class="fr btn_wrap display_block font_weight">
					<a href="javascript://void(0);" id="cancleForm"> 
						<button class="p10 bdr_a0a0a0 bg_ededed" type="button">
							<?php echo $this->lang->line('cancel');?>
						</button>
					</a>
					<a href="javascript://void(0);" id="backStep">
						<button class="p10 bdr_a0a0a0 mr0" type="button">
							<?php echo $this->lang->line('back');?>
						</button>
					</a>
					<button class="red p10 bdr_a0a0a0" type="submit">
