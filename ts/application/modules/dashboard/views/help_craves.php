...
<div class="row">
	<div class="font_opensansSBold clr_f1592a font_size14 lineH20 mt15"> Craves 
		<div class="bdrB_e2e2e2 fr mr20 width_158 mt15"></div>
	</div>
</div>
<div class="row">
	<div class="font_opensansSBold clr_f1592a font_size14 lineH20 mt15">
</div>

<div class="font_size12 font_opensans clr_3d3d3d mt7">To add an Upcoming Project or Event select the radio button next to the Tool you want to use in the Select Tool – Upcoming box, click [new project] and fill in the forms in the wizard.
	<div class="clear"></div>
	...
	<ul class="dashside_inform">
		...
		<li> <img src="<?php echo base_url();?>images/dashboard_images/renew.png" alt="add" class="display_inline mb-10"/> it.</li>
	</ul>
<div class="clear"></div>
