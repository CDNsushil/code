    ...
    <a href="<?php echo $recordDetailUrl;?>"  target="_blank" >
       <div class="cnt_box  bg_fff  ">
          ...
          <div class="display_table m_auto position_relative">
             ...
             <div class="hover_collection"><div class="display_table"><span class="display_cell text_alighC  fs20 opens_light"><?php echo $this->lang->line('LP_ViewUpcomig');?></span></div></div>
          </div>
          <div class="p15">
             <h4 class="fs17 pt3 font_bold lineH20"> <?php echo getSubString($data['projTitle'],40);?></h4>
             <p><?php echo $data['proShortDesc'];?> 
             </p>
          </div>
