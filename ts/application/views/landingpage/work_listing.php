...
//----------make element default project image code start---------//
	...
	<a href="<?php echo $recordDetailUrl;?>"  target="_blank" >
        <div class="cnt_box  bg_fff  ">
          ...
          <div class="p15">
             <h4 class="fs17 pt3 font_bold lineH20"> <?php echo getSubString($data->workTitle,40);?></h4>
             <p><?php echo $data->workShortDesc;?> 
             </p>
          </div>
