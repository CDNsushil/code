  ...
  <div class="toploginbar">
    ...
    <div class="prightnva">
        ...
        <?php if(empty($isLoginUser)){ ?>
          <div class="paralaxbtn fshel_light btntext mr10 mt3"> <a href="javascript:void(0);" onclick="javascript:open_window('<?php echo getFacebookLoginUrl(); ?>');"> <span class="iconspan"> <img src="<?php echo $imgPath; ?>facebooktext.png" alt="fb"></span> <span class="loginicon">Login</span> </a></div>
        <?php } ?>
    </div>
  </div>
  <div class="bg_fff">
