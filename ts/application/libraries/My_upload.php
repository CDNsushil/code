...
if ( ! defined('BASEPATH')) exit('No direct script access allowed');	
    ...
    private function handle_file_upload($uploaded_file, $name, $size, $type, $error, $uploadimagepath) {
        $upload_dir = ROOTPATH.$uploadimagepath;
        $upload_url = $this->getFullUrl().'/'.$uploadimagepath;
								$this->options['upload_dir']=$upload_dir;
								$this->options['upload_url']=$upload_url;
								//echo 	$this->options['upload_dir'].	$this->options['upload_url'];
								$file = new stdClass();
    ...
    public function post($galImagePath) {
				$uploadimagepath = $galImagePath;
        ...
        if ($upload && is_array($upload['tmp_name'])) {
            foreach ($upload['tmp_name'] as $index => $value) {
                $info[] = $this->handle_file_upload(
                    ...
                    $upload['error'][$index],$uploadimagepath
                );
            }
