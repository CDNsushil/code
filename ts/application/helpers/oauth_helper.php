...
class OAuthServer {
  ...
  private function get_token(&$request, $consumer, $token_type = "access") {
    ...
    if (! $token) {
	echo "Invalid $token_type token: $token_field";die;
  ...
  private function check_timestamp($timestamp) {
	...
	echo "Expired timestamp, yours $timestamp, ours $now";
