...
class CI_Email { 
	...
	var	$useragent		= "Toadsquare";
	var	$mailpath		= "/usr/sbin/sendmail";	// Sendmail path
	var	$protocol		= "smtp";	// mail/sendmail/smtp
	var	$smtp_host		= "184.107.217.244";		// SMTP Server.  Example: mail.earthlink.net
	var	$smtp_user		= "admin@cdnsolutionsgroup.com";		// SMTP Username
	var	$smtp_pass		= 'llB8eTk=oKtG';		// SMTP Password
	...
	var	$multipart		= "mime";	// "mixed" (in the body) or "related" (separate)
	...
	public function __construct($config = array())
	{
		...
		if(ENVIRONMENT=='development'){
			...
			$this->smtp_host		= "184.107.217.244";		// SMTP Server.  Example: mail.earthlink.net
			$this->smtp_user		= "admin@cdnsolutionsgroup.com";		// SMTP Username
			$this->smtp_pass		= 'llB8eTk=oKtG';		// SMTP Password
			$this->smtp_port		= 25;	
		}else{
			$this->smtp_host		= "mail.toadsquare.com";		// SMTP Server.  Example: mail.earthlink.net
			$this->smtp_user		= "noreply@toadsquare.com";		// SMTP Username
			$this->smtp_pass		= "und3rc0v3r";		// SMTP Password
			$this->smtp_port		= "25";	
		}
	}
	// --------------------------------------------------------------------
