...
;(function($) {
	...
	//alert($(el).height());
		...
		base.init = function(){
			...
			//*****Added By Gurutva on 8 Sept 2012 to show click image as default*****
			
			if(o.myCurrentPage) 
				base.currentPage = base.targetPage = o.startPanel = o.myCurrentPage;
			else
			...
			base.height = 608;//base.$el.height();
