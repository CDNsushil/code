...
+---------------------------------------------------------------------------+
$Id: banner-edit.php 82775 2013-08-06 23:40:26Z chris.nutting $
*/
...
if ($show_web) {
    ...
    $bannerTypes['upload']['web'] = $GLOBALS['strWebBanner'];
}
if ($show_sql) {
...
if ($show_url) {
	...
	$bannerTypes['create']['create']= $GLOBALS['strCreateBanner'];
if ($show_html) {
...
$advertoptionTypes = array();
$advertoptionTypes['']['']= "Select Size";
$advertoptionTypes['Advert 1']['1']= "250px X 250px";
$advertoptionTypes['Advert 2']['2']= "160px X 600px";
$advertoptionTypes['Advert 3']['3']= "60px X 468px";
//build banner form
...
if ($valid)
{
    ...
    displayPage($bannerid, $campaignid, $clientid, $bannerTypes, $aBanner, $type, $form, $ext_bannertype, $formDisabled,$advertoptionTypes);
}



function displayPage($bannerid, $campaignid, $clientid, $bannerTypes, $aBanner, $type, $form, $ext_bannertype, $formDisabled=false,$advertoptionTypes)
{
	//echo "<pre>";
	//print_r($bannerTypes);
    ...
    $oTpl->assign('advertoptionTypes', $advertoptionTypes);
...
function buildBannerForm($type, $aBanner, &$oComponent=null, $formDisabled=false)
{
    ...
    $form->addElement('hidden', 'adverttype', $type);
...
function processForm($bannerid, $form, &$oComponent, $formDisabled=false)
{
    ...
    $aVariables['adverttype']      = $aFields['adverttype'];
    ...
    if (!empty($_FILES['upload']) && $aFields['replaceimage'] == 't') { //TODO refactor upload to be a valid quickform elem
		...
		if(isset($_POST['adverttype']) && !empty($_POST['adverttype'])) {
