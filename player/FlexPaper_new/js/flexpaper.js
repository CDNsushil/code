...
window.FlexPaperViewerEmbedding = window.$f = function(id, args) {
    ...
    _jsDirectory 		= (config.jsDirectory!=null?config.jsDirectory:BaseURL+"player/FlexPaper_new/js/");
    _cssDirectory 		= (config.cssDirectory!=null?config.cssDirectory:BaseURL+"player/FlexPaper_new/css/");
