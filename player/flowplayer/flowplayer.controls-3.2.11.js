...
$f.addPlugin("controls", function(wrap, options) {
    ...
    function getTime(time, duration) {
       // return "<span>" + toTime(time) + "</span> <strong>" + toTime(duration) + "</strong>";
        return "<strong>" + toTime(time) + "</strong>";
    }
    ...
    var opts = {
        ...
        //template: '<div class="track">' + '<div class="buffer"></div>' + '<div class="progress"></div>' + '<div class="playhead"></div>' + '</div>' + '<div > ' + ' <div class="trackname"> </div>'+ '<div class="time"></div>' + '</div>' + '<div class="play_wrap"> <a class="prev player_btn previous_btn" onclick="parent.previous_media();"  >prev</a> <a class="play">play</a><a class="Next player_btn next_btn" onclick="parent.next_media();">Next</a> <a class="stop player_btn">Stop</a><a class="mute">mute</a> </div>'
        template: '<div class="track">' + '<div class="buffer"></div>' + '<div class="progress"></div>' + '<div class="playhead"></div>' + '</div>' + '<div > ' + ' <div class="trackname"> </div>'+ '<div class="time"></div>' + '</div>' + '<div class="play_wrap"> <a class="prev player_btn previous_btn" "  >prev</a> <a class="play">play</a><a class="Next player_btn next_btn" >Next</a> <a class="stop player_btn">Stop</a><a class="mute">mute</a> </div>'
    };
    ...
    var trackName = byClass(opts.trackNameClass);
    ...
    trackName.innerHTML = opts.trackTitle; // title track add here
    ...
    self.onFinish(function(clip) {
        play.className = opts.playClass;
        //clearInterval(timer); comment by lokendra 13-dec-2014
    });
