...
//console.log(window._atc);


//if (!((window._atc || {}).ver)) {	 remove this condition
    ...
    var _atd = "www.addthis.com/",
        ...
        _atc = {
            ...
            cdn: 0,
            rsrcs: {
                bookmark: _atr + "static/r07/bookmark033.html",
                atimg: _atr + "static/r07/atimg033.html",
                countercss: _atr + "static/r07/counter009.css",
                counterIE67css: _atr + "static/r07/counterIE67004.css",
                counter: _atr + "static/r07/counter011.js",
                core: _atr + "static/r07/core056.js",
                ...
                authjs: _atr + "static/r07/auth009.js",
                ...
                menujs: _atr + "static/r07/menu137.js",
                sh: _atr + "static/r07/sh106.html"
            }
        };
// }
...
(function () {
    ...
    var p = (window.location.protocol == "https:"),
        D, m, z = (navigator.userAgent || "unk").toLowerCase(),
        v = (/firefox/.test(z)),
        o = (/msie/.test(z) && !(/opera/.test(z))),
        c = {
            0: _atr,
            1: "//ct1.addthis.com/",
            2: "//ct2.addthis.com/",
    ...
    _atc.cdn = 0;
    // || window.addthis.nodeType == g  add by me 
    
    if (!window.addthis || window.addthis.nodeType !== g || window.addthis.nodeType == g ) {
        try {
            D = window.navigator ? (navigator.userLanguage || navigator.language) : "";
            m = D.split("-").pop().toLowerCase();
            if (m.length != 2) {
                m = "unk";
            }
            if (_atr.indexOf("-") > -1) {} else {
                if (window.addthis_cdn !== g) {
            ...
            if (_atc.cdn) {
                for (var y in _atc.rsrcs) {
                    if (_atc.rsrcs.hasOwnProperty(y)) {
                        _atc.rsrcs[y] = _atc.rsrcs[y].replace(_atr, typeof (window.addthis_cdn) === "string" ? window.addthis_cdn : c[_atc.cdn]).replace(/live\/([a-z])07/, "live/$107");
                    }
                }
                _atr = c[_atc.cdn];
            }
        ...
        window.addthis = {
            ...
            configure: function (r) {
                ...
                for (var a in r) {
                    if (a == "share" && typeof (r[a]) == "object") {
                        for (var e in r[a]) {
                            if (r[a].hasOwnProperty(e)) {
                                if (!addthis.ost) {
                                    w.addthis_share[e] = r[a][e];
                                } else {
                                    addthis.update("share", e, r[a][e]);
                                }
                            }
                        }
                    } else {
                        if (r.hasOwnProperty(a)) {
                            if (!addthis.ost) {
                                w.addthis_config[a] = r[a];
                            } else {
                                addthis.update("config", a, r[a]);
                            }
                        }
                    }
                }
        ...
        if (document.location.href.indexOf(_atr) == -1) {
            var q = document.getElementById("_atssh");
            if (!q) {
                q = document.createElement("div");
                q.style.visibility = "hidden";
                q.id = "_atssh";
                d(q);
                t.parentNode.appendChild(q);
            }
            function h(a) {
            ...
            if (!q.firstChild) {
                var i, z = navigator.userAgent.toLowerCase(),
        ...
        B.src = (p ? "https:" : "http:") + _atc.rsrcs.core;
        t.parentNode.appendChild(B);
        var l = 10000;
        setTimeout(function () {
            if (!window.addthis.timer.core) {
                if (Math.random() < _atc.ohmp) {
                    (new Image()).src = "//m.addthisedge.com/live/t00/oh.gif?" + Math.floor(Math.random() * 4294967295).toString(36) + "&cdn=" + _atc.cdn + "&sr=" + _atc.ohmp + "&rev=" + _atc.rrev + "&to=" + l;
                }
                if (_atc.cdn !== 0) {
                    var e = document.createElement("script");
                    e.type = "text/javascript";
                    e.src = (p ? "https:" : "http:") + _atr + "static/r07/core056.js";
