...
(function ($) {
  ...
  $.flexslider = function(el, options) {
    ...
    methods = {
      init: function() {
        ...
        slider.prop = (vertical) ? "marginTop" : "marginLeft";
      ...
      directionNav: {
        setup: function() {
          ...
          slider.directionNav.bind(eventType, function(event) {
			var toppostion = $("#sldierul_1").css("margin-top");
			var elmheight  = $("#sldierul_1").height();
  ...
  $.flexslider.defaults = {
    ...
    initDelay: 30,                   //{NEW} Integer: Set an initialization delay, in milliseconds
