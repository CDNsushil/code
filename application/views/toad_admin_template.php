		...
		<ul id="nav">
        	<li>
                <ul class="navigation">
					...
					<li class="<?php echo ($selectedMenu=='select_manage_categories')?$selected_class:'';?>"><a href="<?php echo BASEURL?>admin/settings/manage_categories/index/forums" ><?php echo $this->lang->line('admin_Manage_categories_forum');?></a></li>	
					<li class="<?php echo ($selectedMenu=='select_manage_categories')?$selected_class:'';?>"><a href="<?php echo BASEURL?>admin/settings/manage_categories/index/help" ><?php echo $this->lang->line('admin_Manage_categories_help');?></a></li>	
				</ul>
			</li>
		</ul>
    </div>
