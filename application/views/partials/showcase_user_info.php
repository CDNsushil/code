...
if(!empty($userId)){
  ...
  $creativeArea       = (!empty($userInfo['userArea']))?$userInfo['userArea']:"";
...
$PIC = (!empty($userInfo['enterprise']) && $userInfo['enterprise']=='t')?'bussines_profile':'creave_profile';
$UNC = (!empty($userInfo['enterprise']) && $userInfo['enterprise']=='t')?'green':'red';
    ...
    <div class="creave_header ">
        ...
        <div class="soical_creave fr ">
				...
				if(!empty($getBuyerComment)){  ?>
					<a class="my_site fs16 pr30 fr height20 mt12" href="<?php echo  base_url_lang('buyer_comment/index/'.$userId); ?>"><i class="buyer_comnet fl pr15"></i> Buyers’ Comments   </a>
				<?php 	}	?>	
         </div>
