       ...
       <div class="footer_content">
             ...
             <div class="footer_search_box ">
                ...
                <?php  if(ENVIRONMENT=='production'){  ?>
                    <div class="pa bottom_0 l10px" id="SSLDiv">
                        <table width="135" border="0" cellpadding="2" cellspacing="0" title="<?php echo $this->lang->line('footer_table_title') ?>">
                            <tr>
          ...
          <div class="fr mr40">
             <div class=" fs14 clearb  clr_white">
                <div class="fl"> <span class="fl fs13 mt10">Crave us on</span> 
                    <a target="_blank" class="indexsocial toadsquare" href="<?php echo $crave_url;?>"></a> 
                </div>
                <div class="fr ">
                     <span class="fl mt10 fs13 mr15">Follow us on</span> 
