...
//----------make element default project image code start---------//
    ...
    <a href="<?php echo $recordDetailUrl;?>"  target="_blank" >
        <div class="fans_box bg_fff display_table mb15 width100_per ">
           ...
           <div class="pl22 pr20">
              <div class="fans_title opens_light fs22 ">
                 <?php echo getSubString($userFullName,40);?>
                 <div class="fs16 red pt8"><?php echo limit_words($data->creativeFocus,'40');?></div>
              </div>
              <div class="sap_15"></div>
              <div class="lp_c_text lineH19"><?php echo getSubString($data->optionAreaName,40);?>
              </div>
              <div class="sap_20"></div>
           </div>
           <div class="fans_cuntry head_list open_sans fs15 pl22 lineH30 bg_f3f3f3 height30 bl_F1592A red">
           ...
           <div class="fans_ovelay">
              <div class="display_table height100per">
                 <div class="table_cell opens_light fs24" ><?php echo $this->lang->line('VIEWSHOWCASEHOMEPAGENEW');?>
                 </div>
              </div>
           </div>
           <!--overlay end--> 
