...
if(isset($data) && is_object($data) && count($data) > 0){
    ...
    $recordDetailUrl = base_url(lang().'/mediafrontend/photoartgallery/'.$data->tdsUid.'/'.$data->projId);
        ...
        <div class="cnt_box  bg_fff  ">
          <div class="display_table m_auto position_relative">
            ...
            <div class="hover_collection "><span class="display_cell text_alighC  fs20 opens_light">
                 <?php echo $this->lang->line('LP_ViewMsgcat'.$data->projCategory);?>
            </span></div>
          </div>
          <div class="bg_f3f3f3 pt10 pr15 pb10 text_alignR lp_title"><?php echo getSubString($userFullName,40);?></div>
          <div class="p15">
