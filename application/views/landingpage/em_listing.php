...
if(isset($data) && is_object($data) && count($data) > 0){
    $recordDetailUrl = base_url(lang().'/mediafrontend/educationelement/'.$data->tdsUid.'/'.$data->projId);
    ...
    <a href="<?php echo $recordDetailUrl;?>"  target="_blank" >
        <div class="cnt_box  bg_fff  ">
          ...
          <div class="pl15 pr15 pt12 pb15">
             ...
             <div class="open_sans pt10"><?php echo getSubString($userFullName,60);?></div>
             <div class="pt20 pb10"><?php echo limit_words($data->projShortDesc,'40');?> 
             </div>
          </div>
          <div class="bg_f9f9f9 fl width100_per c_1">
            ...
            <?php 
                if(isset($data->projSellstatus) &&  $data->projSellstatus=="f"){
            ?>
                <span class="fr pt4 open_sans red"> FREE</span>
            <?php } ?>
          </div>
        </div>
