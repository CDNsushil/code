...
if($loggedUserId > 0){
	if($userId==$loggedUserId){
        ...
        $recommendYourself =   $this->lang->line('cannotRecommendYourself');
        
        //check preview mode
        if(previewModeActive()){
          $recommendYourself =   $this->lang->line('cannotRecommendYourselfPreivew');
        }
        
		$recommendFunction="customAlert('".$recommendYourself."')";
