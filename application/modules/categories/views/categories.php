...
?>
    ...
    <ul class="list_mb15 mt30 ml3 mr6 forum_list" id="sub_cat">
        <li><a href="<?php echo base_url_lang('forums'); ?>" >All Categories</a></li>
            ...
            ?>
                <li>
                    <a href="<?php echo base_url_lang('forums/topics/'.$row['CategoryID']); ?>" class="<?php echo $naviSelectedClass; ?>" ><?php echo $row['Name']; ?>&nbsp;[<?php echo  $categories_count; ?>]</a>
                    ...
                    <span class="tab_ul"></span>
                        ...
                        <ul class="sup_form" <?php echo ($isChildMenu)?'style="display:block"':''; ?> >
                            ...
                            <?php  foreach($sub_categories as $sub_row)
                                    ...
                                    <li> <a class="<?php echo ($selectedCategory==$sub_row['CategoryID'])?'red':''; ?>"   href="<?php echo base_url_lang('forums/topics/'.$sub_row['CategoryID']); ?>">- <?php echo $sub_row['Name']; ?>  [<?php echo $categories_count; ?>] </a> </li>
                            <?php  } ?>
