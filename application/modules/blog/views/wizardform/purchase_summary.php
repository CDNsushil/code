<?php if (!defined('BASEPATH')) exit('No direct script access allowed');
	...
	// get blog image url
	$blogImagePath = getBlogImage($blogData,1,'_s');
?>

	<div class="TabbedPanelsContentGroup width_665 m_auto "> 
		<?php echo form_open(base_url(lang().'/membershipcart/payments_pro/addspacecartpayment'),$purchase_form); ?>
			<div class="TabbedPanelsContent">
				...
				<div class="fl">
					<img alt="" src="<?php echo $blogImagePath;?>">
				...
				<ul class="total  purcharse fr " >
					<!--<li class="clearb space_1" >
						<span class="display_cell p_head"> 
							<span class="fs16 font_bold minwidth_165 pr10"><?php //echo $this->lang->line('media_showcase');?></span> 
							<span class="fs13 pl5 fr pr36"> <?php //echo $this->lang->line('validOneYear');?></span>
						</span>
						<span class="price">
		...
		<?php
		//set cancle url
		$data['cancleUrl'] = $baseUrl.'/publiciseblogindex';
		// set next form name
		$data['formName'] = 'purchase_summary';
	   ...
	   $("#purchase_summary").submit(function() {
		...
		var getChkStatus= $('#paymentTermCondition').is(":checked");
		   if(getChkStatus){
			  ...
			  window.location.href="<?php echo base_url(lang().'/membershipcart/payments_pro/addspacecartpayment') ?>";
		   }else{
