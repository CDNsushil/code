...
?>
	<div class="TabbedPanelsContentGroup width635 m_auto "> 
		...
		<?php echo form_open($baseUrl.'/billingdetailspost/',$billing_form); ?>
			<div class="TabbedPanelsContent">
				<div class="wra_head clearb">
					...
					<div id="sellerDetails" class="dn">
						<?php $this->load->view('wizardform/seller_details');?>
					</div>	
	...
	$(document).ready(function() {
		$("#billing_form").validate({
            submitHandler: function() {
                var fromData=$("#billing_form").serialize();
                $.post('<?php echo $baseUrl.'/billingdetailspost/';?>',fromData, function(data) {
                    if(data){
                        if(data.nextStep != '') {
