    ...
    <div class="bg_white">
      <div class="bg_grey_img pt20 pb20 pl20 pr20">
			...
			<div id="imageHolder" class="anythingSlider anythingSlider-default activeSlider">
				...
				<div id="imageDescription" class="width605px"></div>
				<?php
					echo '<div class="dn anythingWindow">';
					echo '<ul id="imageList'.$keyId.'">';
...
<script>
$.gallery={options:{_imageListUL:'#imageList<?php echo $keyId;?>',
