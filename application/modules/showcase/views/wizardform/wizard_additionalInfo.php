    ...
    <div class="wizard_wrap publicity_wrap fs14">
        <div class="TabbedPanels " id="TabbedPanels1">
            ...
            <ul id="man_haedtab" class="TabbedPanelsTabGroup pt16 position_relative z_index_3 publicity_tab">
                <li class="TabbedPanelsTab <?php echo isset($shareMenu)?$shareMenu:'';?>"><a href="<?php echo $baseUrl.'/share';?>"><span>Stage 1 <b>Share</b></span></a></li>
                <li class="TabbedPanelsTab <?php echo isset($emailMenu)?$emailMenu:'';?>"><a href="<?php echo $baseUrl.'/email';?>"><span>Stage 2 <b>Email</b></span></a></li>
                <li class="TabbedPanelsTab <?php echo isset($PRMenu)?$PRMenu:'';?>"><a href="<?php echo $baseUrl.'/prnews';?>"><span>Stage 3 <b>Add Online PR Material </b></a></span></li>
            </ul>
            <!-- ================================main tab content  ======================= -->
