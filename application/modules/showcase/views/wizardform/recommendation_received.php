...
<div class=" pl45 pr25  bg_f3f3f3 fl title_head ">
    ...
    <ul class="dis_nav fs16 mt25 fr mr3">
        <li class="active"> <a href="javascript:void(0);">Recieved</a> </li>
...
<div class="clearbox wizard_wrap minheight_350" id="TabbedPanels1">
    <div class="c_1 m_auto width635">
        <h3>Add a Recommendation to your Homepage or Work Profile.</h3>
         <?php 
        if(!empty($recommendationList)) { ?>
            <h4 class="fs16">Another member has given you and your work a recommendation. You can choose
...
<h3 class="mt25">Ask another member for a recommendation.</h3>
...
<a href="<?php echo $baseUrl.'/editshowcase';?>">
    <button class="b_F1592A bdr_b5b5b5 fr pub_1 mr0"  type="" >Finish</button>
</a>
<div class="sap_25"></div>
</div>
</div>
