...
<div class="TabbedPanels tab_setting" id="TabbedPanels2"> 
    <ul class="TabbedPanelsTabGroup second_ul pt20 pb20">
        <li class="TabbedPanelsTab <?php echo isset($PRnewsMenu)?$PRnewsMenu:'';?>"><a href="<?php echo $baseUrl.'/prnews';?>"><span>Step 1 <b>Add Links to News Articles </b></span></a> </li>
        <li class="TabbedPanelsTab <?php echo isset($PRreviewsMenu)?$PRreviewsMenu:'';?>"><a href="<?php echo $baseUrl.'/prreviews';?>"><span>Step 2 <b>Add Links to Reviews</b></span></a></li>
        <li class="TabbedPanelsTab <?php echo isset($PRinterviewsMenu)?$PRinterviewsMenu:'';?>"><a href="<?php echo $baseUrl.'/prreinterviews'; ?>"><span>Step 3 <b>Add Links to Interviews </b></span></a></li>
    </ul>
