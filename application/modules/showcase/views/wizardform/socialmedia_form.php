...
<ul class="mt25 billing_form form2 clearb fl">
	...
	<li>
		<input class="font_wN url required" type="text" name="socialLink" id="socialLink" value= "" placeholder="Your Social Media Page URL eg. www.facebook.com/pages/Toadsquare/121921117888970*"  onclick="placeHoderHideShow(this,'Your Social Media Page URL eg. www.facebook.com/pages/Toadsquare/121921117888970*','hide')" onblur="placeHoderHideShow(this,'Your Social Media Page URL eg. www.facebook.com/pages/Toadsquare/121921117888970*','show')" />
                                
		<?php //echo form_input($socialLinkArr);?>
	</li>
	<li class="fr mt10 mb10">
		<span>
			<input class="red fr p10 bdr_a0a0a0 fshel_bold width_auto dn socialMediaSubmit" type="button" value="Cancel" id="cancleMedia"/>
		</span>
		<span>
...
$(document).ready(function() {
	$("#socialMediaForm").validate({
		submitHandler: function() {
            ...
            loader();
			$.post(baseUrl+language+'/showcase/addSocialMedia',fromData, function(data) {
				if(data){
