...
<script type="text/javascript">
    ...
    uploadMediaFiles('<?php echo $filePath;?>','<?php echo $mediaFileTypes;?>','<?php echo $this->config->item('imageSize');?>','<?php echo $browseId;?>',1,0,0,'<?php echo $imgload;?>','','_xs','0','<?php echo  $nextUrl; ?>','1','1');
    ...
    $('input[type=file]').change(function() {
		   var fileErrorInput =  $("#fileErrorInput<?php echo $browseId?>").val();
			...
			if(fileErrorInput == 0)
			{
				$("#profile_img").attr('checked', false);
				for(var j =1;j<i;j++)
				{
					$("#stock_img"+j).attr('checked', false);
					runTimeCheckBox();
				}
            }
         });
