...
<div class="bg_f3f3f3 cerative_title clearbox">
    <h1 class="opens_light fs30 fl <?php echo $SHC;?>"><?php echo $sectionHeading;?></h1><?php
    if($fans != "t"){ ?>
...
<div class=" clearbox aboutme_cnt "> <?php
    ...
    <div class="content_creave display_table  pl20 pr20 <?php echo (isset($topHeader) && !empty($topHeader))?'pt18':''; ?>  clearb">
        <?php 
        $sendData = array('projectId'=>$showcaseId,'entityId'=>$entityId,'ownerId'=>$tdsUid,'industryType'=>$industryType,'isPublished'=>'t');
    ...
    if($fans != 't'){ //News Reviews Recomendations
        ...
        $this->load->view('showcase/showcase/news_reviews_recomendations',array('industryId'=>$industryId,'enterPriseName'=>$enterPriseName));
    }else{
