...
if(is_array($craves) && !empty($craves)){
    foreach($craves as $k=>$dt){
        ...
        ?>
            ...
            <div class="border_cacaca width100_per shadow_down mb15 display_table position_relative ptr"  onclick='window.location="<?php echo $recordDetailUrl;?>"'>
                 <?php
                 if($dt->enterprise=='t'){?>
