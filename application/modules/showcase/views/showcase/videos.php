        ...
        <?php
            if(!empty($videoDataShow)){
                ...
                foreach($videoDataShow as $getvideo){
                    ...
                    // video url should not empty
                    if(!empty($src)){
                    ?>
                         <li iframe_<?php echo $countId; ?>= "<?php echo $src; ?>" class="iframe_<?php echo $countId; ?>" >
                            <div class="user_showcase_video">
                            <iframe src="<?php echo $src; ?>" id="iframe_<?php echo $countId; ?>" width="100%" height="100%" frameborder="0"  webkitAllowFullScreen mozallowfullscreen allowFullScreen scrolling="no"></iframe>
                            </div>
