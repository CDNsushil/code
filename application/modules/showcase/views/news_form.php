...
<div class="frm_wp">	
	...
	<input type="hidden" value="" name="formtype" />
		...
		<div class="row" style="width:100%;" >
				...
				<?php  echo anchor('javascript://void(0);', $label['search'],array('class'=>'formTip','title'=> $label['search'],'onclick'=>'javascript:openLightBox(\'listBoxWp\',\'listFormContainer\',\'/showcase/showNewsList\')')); ?>			
				</div>
				
				<div class="cell">|</div>
			
				<div class="cell"  style="padding:0px 5px 0px 5px;"><?php echo anchor('javascript://void(0);', $label['externalSite'],array('class'=>'formTip','title'=> $label['externalSite'],'onclick'=>'$(\'#NEWSForm-Content-Box\').show();')); ?>	
				</div>
		</div>
...
<div class="row">
	...
	<div class="cell widthSpacer10">&nbsp;</div>
			...
			<div class="cell" style="padding-top:5px;"> <img class="ptr" src="<?php echo base_url('images/icons/calendar.png');?>" onclick='$("#publishDate").focus();' /> </div>
	<div class="cell "><span class="cell"><img src="images/icon_I_small2.jpg" /></span></div>
</div>
<div class="row heightSpacer"> &nbsp;</div>
	...
	<div class="cell">
	   <div class="Bdr7">
		...
		<?php
			...
			echo form_dropdown('newsLanguage', $language, set_value('newsLanguage'),'id="newsLanguage" class="required"');
		?>
	  </div>
	  </div>
	</div>
...
<div class="cell">
	 <div class="Btn_wp">
	  <div class="btn_wp" style="padding-left:10px; width: 90px;">
		<div class="button_left">
		  <div class="button_right">
			<div class="button_text" style=" padding-left:10px; font-weight:bold;" onclick="commonCancel('NEWSForm-Content-Box','News-No-Records');">
