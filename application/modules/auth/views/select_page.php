<div class="poup_bx width560 shadow fshel_midum fs14">
   ...
   <h3 class=""><?php echo $this->lang->line('welcome').'&nbsp;'.LoginUserDetails('firstName').'&nbsp;'.LoginUserDetails('lastName').'&nbsp;'?>  </h3>
...
<script type="text/javascript">
	...
	$('#redirectButton').click (function (){
			...
			if(val==1) {	
				...
				window.location.href = '<?php echo base_url_lang('showcase/showcasetype');?>'; 
				...
				window.location.href = '<?php echo base_url();?>'; 
				  ...
				  window.location.href = '<?php echo base_url_lang('tips/front_tips');?>'; 

			    }	
			    else if(val==4){
					
				  window.location.href = '<?php echo base_url_lang('package/information');?>'; 
