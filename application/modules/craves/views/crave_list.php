...
if($ajaxRequest){
 ...
 if($craveData && is_array($craveData) && $craveDataCount > 0){
		...
		<div onclick="gotourl('<?php echo $crave->link;?>',1);" id="uncrave_<?php echo $i ?>" class="border_cacaca shadow_down mb15 display_table fl position_relative">
			<span class="table_cell verti_top  bgf4f4f4 bre9e9e9" > <img src="<?php echo $crave->craveImage;?>" alt=""  /></span>
				...
				<div class="minH148">
					<div class="title_box font_bold"><?php echo $crave->title;?></div>
