...
if(count($currentWorkDetail)>0)	{
 ...
 <!--Middle_column-->
	...
	<td class="bg_DarkGreen" valign="top">
        <div class="cell width_476 sub_col_1 pr9 pl9 bg_DarkGreen">
          <div class="seprator_10"></div>
					 ...
					 <div class="Work_gredient_box pt13 pl20 pr11 pb20">
						...
						<?php if( (@$currentWorkDetail['workCompany']!='') && (strcmp(@$currentWorkDetail['workType'],'wanted')!=0) ) { ?>
         ...
         <div class="scroll_box darkGrey_bg pt7 pb7 bdr_d2d2d2">
            <div class="row">
                ...
                //echo '<pre />';print_r($currentWorkDetail);$this->lang->line('work');die;
					...
					$this->load->view('craves/craveView',array('elementId'=>$defaultWorkId,'entityId'=>$workEntityId,'ownerId'=>$currentWorkDetail['tdsUid'],'projectType'=>'work','isPublished'=>$currentWorkDetail['isPublished'],'furteherDetails'=>'{"projectId":"'.$defaultWorkId.'","table":"Work","primeryField":"workId","imageUrl":"'.$cacheImg.'","fieldSet":"workId as id, workTitle as craveTitle, workShortDesc as craveShortDescription, workTag as tagwords","cacheFilePath":"'.$cacheFile.'"}','tootlTip'=>$this->lang->line('craveMsg')));
					//$selectworkType = ($currentWorkDetail['workExperiece']=='t') ? $this->lang->line('workWantExp') : $currentWorkDetail['workType'] ; 
	...
	<?php } ?>	  	
     <div class="clear seprator_10"></div>      
	 <div class="sumRtnew_strip clr_white pl10 height_32"><?php echo "Work ".ucfirst($selectworkType) ?> </div>
        ...
        <div class="cell width_284 pl10 pr10 sub_col_2 bg_DarkGreen">
          ...
          <div class="scroll_box darkGrey_bg global_shadow pt15 pb15 bdr_d2d2d2">
            ...
            <div class="Fleft ml20 <?php echo $divWidth;?>">
              <div class="AI_table">
                <div class="AI_cell">				
					<img border="0" src="<?php echo $thumbImg;?>" class="wp_topimg_thumb  <?php echo $imgWidth; ?> bdr_d2d2d2">
				</div>
              </div>
            </div>
            <?php 
            ...
            <div class="ml20 mr20 mt25">
              <div class="font_opensansSBold clr_white ">
                ...
                <div class="summery_posted_wrapper bdr_T666666"><span class="cell width_90 pl16"><?php echo $this->lang->line('workExperience');?></span>
                <div class="clear"></div>
                </div>
                <?php } else {  					
