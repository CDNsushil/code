          ...
          <div class="scroll_box darkGrey_bg global_shadow pt15 pb10 bdr_d2d2d2">
            <div class="clr_white font_size14 pl20"><b>Video</b></div>
				<div class="ml17 mr17 mt11">
					...
					$mediaArray['elementID']=$promo_video[0]['workId']; //element id
					$mediaArray['projectID']=$promo_video[0]['workId']; // project id
					...
					$mediaId= $promo_video[0]['fileId'];  // media file Id
						...
						$elementId=$promo_video[0]['workId']; //element id
						$projectId=$promo_video[0]['workId'];  // project id
				...
				<div class="font_opensansSBold clr_white">
					...
					<div class="line8"></div>
					<div class="font_size11 mt6 mb3"><?php echo getSubString(@$promo_video[0]['mediaDescription'],150); ?></div>			
				</div>        
				</div>
		</div>
