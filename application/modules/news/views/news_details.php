...
<div class="row content_wrap" >
    ...
    <div class="width100_per clearb position_relative">
        <a href="<?php echo base_url('news/index');?>" class="fl close_btn closebig position_absolute"></a>
        <div class="width742 m_auto clearb">
					...
					if(!empty($getFileId))
					{
						...
						if(!empty($getFileId['videoFile']) && $getFileId['videoFile'] > 0)
						{
							...
							/****************Show news video code here************/
								...
								{
									$getSrc = base_url().'en/player/getPlayerIframe/'.$mediaId.'_full/'.$entityId.'/'.$elementId.'/'.$projectId;
								}
								
								echo  ' <iframe src="'.$getSrc.'" width="467" height="264" class="bg_313131_imp" frameborder="0"  webkitAllowFullScreen mozallowfullscreen allowFullScreen scrolling="no"></iframe>';			
            ...
            <div class="btn_wrap fr">
                <a href="<?php echo base_url('news/index');?>"><button class=" height40" type="button" > Close</button></a>
