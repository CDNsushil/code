...
$formAttributes = array(
    'name'=>'billling_detail_form',
    'id'=>'billling_detail_form',
);
...
// set base url
$baseUrl = base_url(lang().'/membershipcart');
?>
	<div class="TabbedPanelsContentGroup width635 m_auto "> 
		<!--==========================     Step 3 Billing Information ==============================-->
		<?php echo form_open($baseUrl.'/billingdetailspost/',$formAttributes); ?>
			<div class="TabbedPanelsContent">
				<div class="wra_head clearb">
					...
					$data['formName'] = 'billling_detail_form';
                    $data['backPage'] = 'managecart';
