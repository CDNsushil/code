...
<?php 
echo form_open(base_url('membershipcart/payments_pro/freeRenew'),$formAttributes);
...
if(isset($productDetails) && is_array($productDetails) && count($productDetails)>0) {
   ...
   if(isset($totalExtraPrice) && $totalExtraPrice!=''){
	   $totalPrice =$totalExtraPrice + $item[0]->price;			   
			...
			<input type="hidden" name="amount_<?php echo $itemno ?>" value="<?php echo $priceAftrVat ?>">
               ...
               <div class="SCart_item_left fl">
                ...
                <div class="clear"></div>
					...
					<div class="fl width_142 text_alignR <?php echo $class ?>"> <?php echo $item[0]->duration ?> <?php echo $this->lang->line('months'); ?>  </div>
					<div class="fr text_alignR <?php echo $class ?>">

					<div class="fl">€</div> <div class="fr pr30 mr5 <?php echo $class ?>"><?php echo number_format($item[0]->price,2) ?></div>  
					</div>
					<div class="clear"></div>
					</div>
					<div class="seprator_10"></div>
...
<div id="productprice_<?php echo $cartItemId; ?>" class="dn" ><?php echo $priceAftrVat ?></div>                        
         <div class="dash_Atool_footer pl46 pt0 pb0 minH50 font_stylen">
         	<div class="tds-button fr mt5"> <a onclick="deleteProduct('<?php echo $cartItemId; ?>');" onmousedown="mousedown_tds_button(this)" onmouseup="mouseup_tds_button(this)" ><span class=" font_opensansSBold" ><?php echo $this->lang->line('Remove'); ?></span></a> </div>
            
            <div class="tds-button fr mr80 mt5"> <a href="<?php echo base_url(lang().'/membershipcart/buyspace')?>" onmousedown="mousedown_tds_button(this)" onmouseup="mouseup_tds_button(this)" ><span class=" font_opensansSBold " ><?php echo $this->lang->line('ChangeSpace'); ?></span></a> </div>
              ...
              <?php } ?>   
                ...
                <div class="row bg_f1592a font_size13 clr_white pt4 pb4 position_relative">
                            <div class="fl font_opensansSBold width_180 mr24 text_alignR"><?php echo $this->lang->line('TotalPrice'); ?></div>
                  			<div class="fl font_opensansSBold width_66">
		...
		$k++;$itemno++;	
			 ...
			 <div class="toggles" style="display:none;">			
                ...
                <div class="extract_button_box  Fleft fl ml_435 mt_minus10">
		           ...
		           <?php $productDetails = (isset($productDetails) && $productDetails>0) ? count($productDetails) :0;
...
<div class="seprator_30"></div>
          ...
          <div class="clear"></div>   
     <div class="tds-button-change mt10"> <a href="<?php echo base_url(lang().'/membershipcart/confirmBilling') ?>" onmouseup="mouseup_tds_button_change(this)" onmousedown="mousedown_tds_button_change(this)"><span class=" font_opensansSBold width_60">Modify</span></a> </div>        
             <div class="clear"></div>
             
         <?php if ($cartTotal>0){ ?>
				 <div class="pt20">
						<div class="defaultP">
								<input type="checkbox" name="termsNCond"  value="" <?php //echo $checked ?>  onclick="showPaypalBtn();" class="productpricechk" />
								<div class="inline pl10"> I acknowledge to have read, understood and agreed the <a class= "underline dash_link_hover" target="_blank" href="<?php echo base_url(lang().'/cms/termsncondition') ?>"> Terms & Conditions </a> of the Toadsquare <div class="inline pl10">website. </div> </div>
							</div>
             ...
             <div class="seprator_34"> </div>
              <div class="fl font_opensansSBold ml20"><?php echo $this->lang->line('PaySecurelyusing'); ?></div> <div class="fl ml24"> <img src="<?php echo base_url('images/paypal_logo.png')?>"> </div>
              <div class="tds-button-orange Fright mr30 mt_minus5 dn" id='paypalButton'> <a href="<?php echo base_url(lang().'/membershipcart/payments_pro/sendPaypalData')?>"  onmouseup="mouseup_tds_button_orange(this)" onmousedown="mousedown_tds_button_orange(this)"><span class=" font_OpenSansBold width_90"><?php echo $this->lang->line('PayNow'); ?></span></a> </div>
          <?php if ($cartTotal>0) { ?>     
              <div class="tds-button-orange Fright mr30 mt_minus5 opacity_4" id='sendPaypalButton'> <a onclick="javascript:void(0)" onmouseup="mouseup_tds_button_orange(this)" onmousedown="mousedown_tds_button_orange(this)"><span class=" font_OpenSansBold width_90"><?php echo $this->lang->line('PayNow'); ?></span></a> </div>
            <?php } ?>  
 <?php if (($cartTotal==0) && ($purchaseType==3)) { ?>                
  <div class="tds-button-orange Fright mr30 mt_minus5" id='paypalButton'> <a href="<?php echo base_url(lang().'/membershipcart/payments_pro/freeRenew')?>" onmouseup="mouseup_tds_button_orange(this)" onmousedown="mousedown_tds_button_orange(this)"><span class=" font_OpenSansBold width_90"><?php echo $this->lang->line('PayNow'); ?></span></a> </div>            
   <?php } ?>           
              </div>
