...
<div class="label_wrapper cell"><div class="lable_heading"><h1><?php echo $label['ASSOCIATEDMEDIAS'];?></h1></div></div>
...
echo '<div id="ASSOCIATEDMEDIAS-No-Records" class="row pl20">';

//echo $label['clickHere'].$label['associateElements'].anchor('javascript://void(0);', $label['ASSOCIATEDMEDIAS'],array('class'=>'formTip','title'=>$label['ASSOCIATEDMEDIAS'],'onclick'=>'showRelatedForm(\'ASSOCIATEDMEDIASForm-Content-Box\',\'ASSOCIATEDMEDIAS-No-Records\');'));
echo anchor('javascript://void(0);', $label['add'],array('class'=>'formTip','title'=>$label['ASSOCIATEDMEDIAS']));
echo '</div>';
echo '<div class="row heightSpacer"> &nbsp;</div>';
//}
?>
