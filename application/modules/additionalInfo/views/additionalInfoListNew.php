...
if($AdditionalInfoFlag){
    ...
    <h4 class="  bg_f3f3f3 pt8 pb8 pl23 pr23 width250 bdr_ebeb  "><?php echo $this->lang->line('On_the_web'); ?> </h4>
    <div class="box_wrap clearb on_web_div fl width250  ">
        ...
        ?>
            <div id="additionalInfoSlider<?php echo  $i+1; ?>" slidercount="1" class="slider hori_slide   <?php echo ($i < 2)?'pb14 mb10 bb_b6b6b6':''; ?> ">
               <h4 class="mb12 red "><?php echo $sections[$i]; ?> </h4>
               <a class="buttons prev" href="#"><img src="<?php echo $imgPath; ?>arr_l.png" alt="" /> </a> 
               <span class="counter1 cnt_no position_absolute  "><span class="current_slide">1</span>/<span class="total_slide"><?php echo $infoSectionCount; ?></span></span>
               <div class="viewport  verti">
