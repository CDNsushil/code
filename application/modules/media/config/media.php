...
$config['filmvideo_bkendmathod'] = 'filmvideo/editproject';
$config['writingpublishing_bkendmathod'] = 'musicaudio/editproject';
$config['musicaudio_bkendmathod'] = 'writingpublishing/editproject';
$config['photographyart_bkendmathod'] = 'photographyart/editproject';
$config['educationmaterials_bkendmathod'] = 'educationmaterials/editproject';
...
//new frontend method name
$config['filmvideo_frntmathodnew'] = 'mediashowcases';
$config['writingpublishing_frntmathodnew'] = 'writingdetails';
$config['musicaudio_frntmathodnew'] = 'aboutalbum';
$config['photographyart_frntmathodnew'] = 'photoartdetails';
$config['educationmaterials_frntmathodnew'] = 'educationdetails';
$config['newswizard_frntmathodnew'] = 'newscollection';
$config['reviewswizard_frntmathodnew'] = 'reviewscollection';
