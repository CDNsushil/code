    ...
    <?php   
        ...
        if((isset($isPublished) && $isPublished=='f') || previewModeActive()){
            ...
            if(previewModeActive()){
                $onclickFunction="customAlert('You cannot add news in preview mode.')";
            }
...
<?php if($reviewdesign==1){ ?>
        <button class="review button_c fs11" onclick="<?php echo $onclickFunction;?>" type="button">Add News Article </button>
<?php }elseif($reviewdesign==2){ ?>
        <li><a href="javascript:void(0)" onclick="<?php echo $onclickFunction;?>"> <span class="fl">Add News Article</span> <i class="ab_share review_me"></i></a></li>
<?php }elseif($reviewdesign==3){ ?>
         <button class="review button_c fr fs11" onclick="<?php echo $onclickFunction;?>" type="button">Add News Article</button>
<?php } ?>

<script type="text/javascript">
    function userreview(reviewData<?php echo $reviewProjectId.'_'.$reviewElementId;?>,isReviewForm){
        
        var redirecturl      =  "/media/newswizard";
        ...
        $.ajax({
          ...
          success: function(data) {
                ...
                if(data.issuccess==true){
                    ...
                    customAlert('You can not add news on this.','Error');
                }
            },  
