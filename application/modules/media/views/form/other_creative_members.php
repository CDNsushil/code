...
// set back url
$backPage = '/selectcollectioninfo/'.$projectId;
// set next url
$nextPage = '/selectassociatedmedia/'.$projectId;
$elementIdVal = $projectId;
if(isset($elementId) && !empty($elementId)) {
    // set back url
    $backPage = '/uploadimageinfo/'.$projectId.'/'.$elementId;
    // set next url
    $nextPage = '/nextmediaoptions/'.$projectId.'/'.$elementId;
    // set element id if project element id exists
    $elementIdVal = $elementId;
    $data['isPausestep'] = 1;
}
