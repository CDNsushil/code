	...
	<div class="TabbedPanelsContentGroup width_665 m_auto ">
		<?php echo form_open(base_url(lang().'/membershipcart/payments_pro/mediacartpayment'),$purchase_form); ?>
			<div class="TabbedPanelsContent">
				...
				<h4 class="font_bold fs14	"><?php echo $projRes->projName;?></h4>
				...
				<div class="bill_detail clearb color_666 ">
					...
					<p>
						<a href="<?php echo $absoluteFormUrl.'/renewbillingdetails'; ?>">
				...
				<?php 
				$data['backUrl'] = base_url($this->router->fetch_class().DIRECTORY_SEPARATOR.$this->router->fetch_method().DIRECTORY_SEPARATOR.'renewbillingdetails');
