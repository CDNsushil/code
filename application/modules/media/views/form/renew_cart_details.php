...
// get project container id from session
$projectContainerId = $this->session->userdata('projectContainerId'); 
$projectContainerIdInput = array(
	'name'	=> 'projectContainerId',
	'type'	=> 'hidden',
	'id'	=> 'projectContainerId',
	'value'	=> (isset($projectContainerId))?$projectContainerId:0
);
...
<div class="TabbedPanelsContentGroup width_665 m_auto "> 
	...
	<?php echo form_open($absoluteFormUrl.DIRECTORY_SEPARATOR.'membershipcartpost'.DIRECTORY_SEPARATOR,$mce); ?>
		<div class="TabbedPanelsContent">
			...
			<?php
			$data['backUrl'] = base_url($this->router->fetch_class().DIRECTORY_SEPARATOR.$this->router->fetch_method().'/editproject/'.$projectId);
		...
		echo form_input($projectContainerIdInput); 
