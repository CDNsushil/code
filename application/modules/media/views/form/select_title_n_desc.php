...
$projName = array(
    'name'        =>  'projName',
    'id'          =>  'projName',
    'class'       =>  'required width527 min-height_25 mt14 bdr_adadad specificdb ',
    ...
    'placeholder' =>  $this->lang->line('Cltitle'),
    'onBlur'      =>  "placeHoderHideShow(this,".$this->lang->line('Cltitle'.$projCategory).",'show')",
    'onClick'     =>  "placeHoderHideShow(this,".$this->lang->line('Cltitle'.$projCategory).",'hide')"
);
...
$projShortDesc = array(
    ...
    'placeholder' =>  $this->lang->line('CltitleIn'.$projCategory),
    'onBlur'      =>  "placeHoderHideShow(this,".$this->lang->line('CltitleIn'.$projCategory).",'show')",
    'onClick'     =>  "placeHoderHideShow(this,".$this->lang->line('CltitleIn'.$projCategory).",'hide')"
);
...
$projDescriptionProject = array(
    ...
    'placeholder' =>  $this->lang->line('CltitleInAb'.$projCategory),
    'onBlur'      =>  "placeHoderHideShow(this,".$this->lang->line('CltitleInAb'.$projCategory).",'show')",
    'onClick'     =>  "placeHoderHideShow(this,".$this->lang->line('CltitleInAb'.$projCategory).",'hide')"
);
...
$tagWords = array(
    ...
    'placeholder' =>  $this->lang->line('tagword'),
    'onBlur'      =>  "placeHoderHideShow(this,".$this->lang->line('tagword').",'show')",
    'onClick'     =>  "placeHoderHideShow(this,".$this->lang->line('tagword').",'hide')"
);
    ...
    <?php echo form_open($baseUrl.'/settitlendescription/'.$projectId.'/'.$elementId,$formAttributes); ?>
        <div class="c_1 clearb mb25 ">
            <ul class="form_img mt25">
                <li>
                    <h4 class="fs21 bb_aeaeae red"><?php echo $this->lang->line('Cltitle'.$projCategory);?></h4>
                ...
                <li>
                <h4 class="fs21 bb_aeaeae red"><?php echo $this->lang->line('CltitleIn'.$projCategory);?></h4>
                ...
                <li>
                <h4 class="fs21 bb_aeaeae red"><?php echo $this->lang->line('CltitleInAb'.$projCategory);?></h4>
                ...
                <li>
                    <h4 class="fs21 bb_aeaeae red"> <?php echo $this->lang->line('tagword'); ?> </h4>
                    <span class="red fs13 fshel_midum"><?php echo '3 - 25' .$this->lang->line('words');?></span>
