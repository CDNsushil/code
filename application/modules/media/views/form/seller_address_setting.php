...
$seller_zipInput = array(
	'name'=> 'seller_zip',
	'id'=>'seller_zip',
	'class'=> 'number required font_wN width_160',
...
// set after save redirect url
$redirectUrl = $baseUrl.'/uploadform/'.$elementId;
if(!empty($isEditMedia)) {
	$redirectUrl = $baseUrl.'/editproject/'.$elementId;
}
?>
<div class="wra_head clearb">
    <h3 class="red fs21 "> <?php echo $this->lang->line('whatSellerDetails');?> </h3>
    ...
    <?php echo form_open($baseUrl,$formAttributes); ?>
        ...
        <div class="fr btn_wrap display_block font_weight">
           <a href="<?php echo site_url(lang().'/media/'.$industry.'/'.$elementId);?>" id="cancleForm"> 
            ...
            <a href="<?php echo $baseUrl.'/sellerpaypal/'.$elementId;?>" id="backStep">
