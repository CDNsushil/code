        ...
        <?php echo form_open($baseUrl.'/domesticshippingstates/'.$projectId.'/'.$elementId,$domesticShippingForm); ?>
             <div class="TabbedPanelsContent">
                ...
                <div class="c_1" id="domestic_shipping">
                    <h3 class="red fs21 ">Domestic Shipping*</h3>
                    <ul class=" mt30 billing_form domestic_country position_relative height_30 custom_domestic_country">
                    ...
                    <div class="wra_head">
                        <h3 class="red fs21 ">Is the Rate the same for all States, Provinces &amp; Regions?*</h3>
                        <ul class=" mt30 display_table clearb  rate_wrap ">
                    ...
                    <div class="wra_head">
                        <h3 class="red fs21 mb25 "> How will you deliver your Prints?* </h3>
   ...
   $(document).ready(function() {
        $("#domesticShippingForm").validate({
            submitHandler: function() {
				...
				$('#domesticShippingForm').submit();
                /*$.post('<?php echo $baseUrl.'/savedomesticprimarydata/'.$projectId.'/'.$elementId;?>',fromData, function(data) {
                    if(data){
                        window.location.href = '<?php echo $baseUrl.'/domesticshippingstates/'.$projectId.'/'.$elementId;?>';
                    }
                }, "json");*/
            }
        });
