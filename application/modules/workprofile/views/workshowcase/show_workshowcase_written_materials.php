<?php echo form_open('workProfile/workshowcase/deleteMedia',"name='mediaForm'");
	...
	echo form_hidden('mediaType','WrittenMaterial');
?>
		...
		?>
			<div class="all_list_item ">
				<div class="pb10" style="min-height:85px">
					...
					<?php
							$writtenMaterialPath ='media/'.LoginUserDetails('username').'/workshowcase/WrittenMaterial/'.$row['mediaName'];
							//echo getImage($writtenMaterialPath);
							?>
							
						<div style="display:inline-table;float:left;">
							<?php if($row['mediaName'] !=''){?>
							<img width="90" src="<?php echo getImage($writtenMaterialPath);?>" />
							<?php }else{?>
								...
								<div class="title-content-left">
									<div class="title-content-right">
										<div class="title-content-center">
											...
											<?php
												//History Edit Icon
												echo anchor('workProfile/workshowcase/addMoreWrittenMaterial/'.$row['mediaId'], '<span><div class="projectEditIcon"></div></span>');	
												//History Delete Icon
