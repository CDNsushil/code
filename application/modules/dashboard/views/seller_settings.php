...
$seller_pickupzip = array(
	...
	'id'=>'seller_pickupzip',
	'class'=> 'number required font_wN width_190',
	...
	<div class="TabbedPanelsContent TabbedPanelsContentVisible">
		<div id="TabbedPanels5" class="TabbedPanels tab_setting">
				...
				<ul class="TabbedPanelsTabGroup width100_per not_clickable <?php echo $menuNotClickable ?>">
					<li class="TabbedPanelsTab ssSabMenu TabbedPanelsTabSelected" ><a href="javascript:void(0)" ><span><b><?php echo $this->lang->line('subheadingCurrency');?> </b></span></a></li>
					<li class="TabbedPanelsTab cunsum_tax ssSabMenu"><a href="javascript:void(0)" ><span><b><?php echo $this->lang->line('subheadingConsumptionTax');?></b></span></a></li>
					<li class="TabbedPanelsTab ssSabMenu" ><a href="javascript:void(0)" ><span><b><?php echo $this->lang->line('subheadingPayPal');?></b></span></a></li>
					<li class="TabbedPanelsTab ssSabMenu "><a href="javascript:void(0)" ><span><b><?php echo $this->lang->line('subheadingSellerDetails');?></b></span></a></li>
					<li class="TabbedPanelsTab ssSabMenu" ><a href="javascript:void(0)" ><span><b><?php echo $this->lang->line('subheadingShipping');?></b></span></a></li>
				</ul>
				
				<ul class="TabbedPanelsTabGroup width100_per clickable <?php echo $menuClickable ?>">
					<li class="TabbedPanelsTab ssSabMenu TabbedPanelsTabSelected" tabindex="0" id="cdMenu" onclick="hideShow(this,'#cd','.ssContents','slow','.ssSabMenu','TabbedPanelsTabSelected');"><a href="javascript:void(0)" ><span><b><?php echo $this->lang->line('subheadingCurrency');?></b></span></a></li>
					<li class="TabbedPanelsTab cunsum_tax ssSabMenu" tabindex="0" id="ctMenu" onclick="hideShow(this,'#ct','.ssContents','slow','.ssSabMenu','TabbedPanelsTabSelected');"><a href="javascript:void(0)" ><span><b><?php echo $this->lang->line('subheadingConsumptionTax');?></b></span></a></li>
					<li class="TabbedPanelsTab ssSabMenu" tabindex="0" id="pdMenu" onclick="hideShow(this,'#pd','.ssContents','slow','.ssSabMenu','TabbedPanelsTabSelected');"><a href="javascript:void(0)" ><span><b><?php echo $this->lang->line('subheadingPayPal');?></b></span></a></li>
					<li class="TabbedPanelsTab ssSabMenu " tabindex="0" id="sdMenu" onclick="hideShow(this,'#sd','.ssContents','slow','.ssSabMenu','TabbedPanelsTabSelected');"><a href="javascript:void(0)" ><span><b><?php echo $this->lang->line('subheadingSellerDetails');?></b></span></a></li>
					<li class="TabbedPanelsTab ssSabMenu" tabindex="0" id="shMenu" onclick="hideShow(this,'#sh','.ssContents','slow','.ssSabMenu','TabbedPanelsTabSelected');"><a href="javascript:void(0)" ><span><b><?php echo $this->lang->line('subheadingShipping');?></b></span></a></li>
				</ul>
					...
					<div class="TabbedPanelsContentGroup ssContents dn" id="ct">
						...
						<div id="consumption_tax_div" > 
							<?php $this->load->view('dashboard/consumption_tax');?>	
						</div>
						<div id="charge_consumption_tax_div" class="dn"> 
							<?php $this->load->view('dashboard/charge_consumption_tax');?>	
						</div>
						<div id="consumption_state_tax_div" class="dn"> 
							<?php $this->load->view('dashboard/consumption_state_tax');?>	
						</div>
					</div>
							 ...
							 <div class="TabbedPanelsContent shipContent TabbedPanelsContentVisible">
                              ...
                              <?php echo form_open($this->uri->uri_string(),$formdomesticShipping); ?>
									...
									<?php echo form_close(); ?>
									    ...
									    <?php $this->load->view('dashboard/seller_international_shipping');?>   
