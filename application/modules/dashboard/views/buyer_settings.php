...
<div class="TabbedPanelsContentGroup main_tab m_auto "> 
	...
	<div class="TabbedPanelsContent TabbedPanelsContentVisible">
			...
			<ul class="TabbedPanelsTabGroup scond_li">
				<li class="TabbedPanelsTab bsSabMenu TabbedPanelsTabSelected" id="bdMenu" onclick="hideShow(this,'#bd','.bsContents','slow','.bsSabMenu','TabbedPanelsTabSelected');"><a href="javascript:void(0)" ><span><b>Billing Details</b></span></a></li>
				<li class="TabbedPanelsTab bsSabMenu " id="sdMenu"  onclick="hideShow(this,'#sd','.bsContents','slow','.bsSabMenu','TabbedPanelsTabSelected');"><a href="javascript:void(0)" ><span><b>Shipping Details</b></span></a></li>
			</ul>
			<div class="TabbedPanelsContentGroup bsContents" id="bd"> 
				<div class="TabbedPanelsContent TabbedPanelsContentVisible">
					<div class="wra_head clearb">
						...
						<ul class=" billing_form form1" >
							...
							<li class=" width_258 select select_1">
									<?php
										...
										echo form_dropdown('billing_country', $countryList, $billing_country,'id="billing_country" class="main_SELECT countriesList" onchange="getStateList(\'billingState\',this.value,\'billing_state\',\'main_SELECT\');"');
									?>
							</li>
							<li class=" width_258 select select_2 stateListDiv" id="billingState">
								<?php    
						...
						<h4 class="red fs21 mt52 bb_aeaeae"> <?php echo $this->lang->line('taxInfo');?> </h4>
								 ...
								 <ul class=" billing_form form1" >
										...
										<li class=" width_258 select select_1">
											 <?php
													...
													echo form_dropdown('shipping_country', $countryList, $shipping_country,'id="shipping_country" class="main_SELECT countriesList" onchange="getStateList(\'shippingState\',this.value,\'shipping_state\',\'main_SELECT\');"');
												?>
										</li>
										<li class="width_258 select select_2 stateListDiv" id="shippingState">
											 <?php    
