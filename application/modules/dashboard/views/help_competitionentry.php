...
<div class="row">
	<div class="font_opensans font_size14 clr_black lineH22 pb5">Please read the <a href="<?php echo site_url().'dashboard/loadWelcomePage/welcome_competitionentry';?>"><span class="display_inline clr_f1592a font_opensansSBold gray_clr_hover underline"> Competition Entry Welcome </span></a><br> before you use this section.
		<div class="bdrB_e2e2e2 fr mr20 width_158 mt15"></div>
	</div>
</div>
<div class="row">
	<div class="font_opensansSBold clr_f1592a font_size14 lineH20 mt15">Competition Entry
</div>
...
<div class="font_size12 font_opensans clr_3d3d3d mt7">
	...
	<ul class="dashside_inform">
		...
		<img src="<?php echo base_url();?>images/dashboard_images/renew.png" alt="add" class="display_inline mb-10"/> it.</li>
	</ul>
<div class="clear"></div>
