...
function checkState(){
	...
	var domesticPrice ;
		...
		$(':checkbox:checked').each(function(i){
            ...
            if(t>0){
                    customAlert('Please fill the value of checked filled ');
                    return false;           
                }
	}	
	//runTimeCheckBox();
     ...
     */
         $('.checkboxStates').each(function(){
           if($(this).is(":checked")){
            ...
            {
                $("#checkStates").parents('div').addClass("ez-checked");
                $("#checkStates").attr('checked','checked');               
            }else
            {
              $("#checkStates").parents('div').removeClass("ez-checked");
              $("#checkStates").removeAttr('checked');             
