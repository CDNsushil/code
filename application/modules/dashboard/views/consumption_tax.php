			...
			<ul class=" display_table mb22 clearb">
				<li class="defaultP ">
					<label class="tax_no width_112">
						...
						?>
						<input type="radio" <?php echo $chargeConsumptionTaxNo;?> value="f" id="chargeConsumptionTaxNo" name="chargeConsumptionTax" onclick="$('#consumptionTaxinfo').hide()"   />
						No 
					</label>
					<label class="ml88 tax_yes">
						<input type="radio" <?php echo $chargeConsumptionTaxYes;?>  value="t" id="chargeConsumptionTaxYes" name="chargeConsumptionTax" onclick="$('#consumptionTaxinfo').show();" />
						Yes
					</label>
				</li>
			</ul>
