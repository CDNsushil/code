	...
	<div class="TabbedPanelsContent TabbedPanelsContentVisible">
		...
		<!--========================== stage 2 :- second tab  ==============================-->
			...
			<ul class="TabbedPanelsTabGroup scond_li">
				<li class="TabbedPanelsTab msSabMenu TabbedPanelsTabSelected" id="msMenu" onclick="hideShow(this,'#ms','.msContents','slow','.msSabMenu','TabbedPanelsTabSelected');"><a href="javascript:void(0)" ><span><b>Membership Settings</b></span></a></li>
				<li class="TabbedPanelsTab msSabMenu"  id="spMenu" onclick="hideShow(this,'#sp','.msContents','slow','.msSabMenu','TabbedPanelsTabSelected');"><a href="javascript:void(0)"><span><b>Search Preferences</b></span></a></li>
				<li class="TabbedPanelsTab msSabMenu" id="daMenu" onclick="hideShow(this,'#da','.msContents','slow','.msSabMenu','TabbedPanelsTabSelected');"><a href="javascript:void(0)"><span><b>Delete your Account</b></span></a></li>
			</ul>
