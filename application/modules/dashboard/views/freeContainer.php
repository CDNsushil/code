			...
			<div class="pl20 pr20">
				<div class="dash_Atool_text pl0 pb5 pr2 fl ml_138 minH50">
					...
					echo form_open($formSubmitUrl,$formAttributes);
						...
						<div class="tds-button fr ml20 container_box"> <a href="<?php echo base_url(lang().'/package/buytools');?>" onmouseup="mouseup_tds_button(this)" onmousedown="mousedown_tds_button(this)"><span class="font_size12 font_opensansSBold width_80"><?php echo $this->lang->line('addSpace');?></span></a> </div>
