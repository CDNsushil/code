...
<div id="divCounter<?php echo $divCounter; ?>"  class="<?php echo ($divCounter=="1")?'':'dn'; ?>">
  <h3 class="red  fs21 lettr_spacing-2 whitespace_now bb_aeaeae"><?php echo $this->lang->line('pack_refund_photographyNart_heading'); ?></h3>
  ...
  <?php 
    ...
    foreach($projectDataList as $projectdata){
      ...
      //get art files count data 
      $projectElementData      =  getDataFromJoinTabel('PaElement',$projectId);
      $artFilesCount   = 0;
      //count of art files
  ...
  ?>
	...
	<div class="width100_per mt40  defaultP">
		...
		<div class="fl">
			...
			<p class="pt5"><b>Photography Album</b></p>
		</div>
		<ul class="total fr">
			<li class="clearb" >
     ...
     <div class="collaborat_wrap pl15 pr15 pt8 pb15 fr width_545 shadow_light bdr_c3c3c3">
        <div class="bb_F1592A display_block width100_per fl  mb5 pb4">
           ...
           <div class=" fr text_alignR fs13 font_weight lineH20 ">
              <p class="red">Photography Album</p>
        ...
        <ul  class=" fs13 collabration_wrap pt18 clearb fl width100_per">
           ...
           <li class="width152 bdrR_c3c3c3 bdrL_c3c3c3">
             ...
             <span > <b class="red fs14"><?php echo $artFilesCount; ?></b> Downlodable Files</span> <span class="sap_10"></span> 
             <span > <b class="red fs14"><?php echo $artFilesCount; ?></b> Print </span> </li>
           <li class="pr0  pl0 width180 pl0  mr-15 bdr_non" ><span><img src="<?php echo $projectImage; ?>" alt="" class="maxWidth165px maxHeight113px" /></span></li>
        </ul>
     </div>
    ...
    <input type="hidden" name="<?php echo $userContainerId; ?>_industrySection" value="Photography Album">
