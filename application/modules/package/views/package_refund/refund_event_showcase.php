<div id="divCounter<?php echo $divCounter; ?>" class="<?php echo ($divCounter=="1")?'':'dn'; ?>">
  ...
  <h3 class="red  fs21 fnt_mouse bb_aeaeae"><?php echo $this->lang->line('pack_refund_eventShowcase_heading'); ?></h3>
  ...
  <?php 
    ...
    foreach($projectDataList as $projectdata){
      ...
      $dirname               =   'media/'.LoginUserDetails('username').'/events/'.$projectId.'/';
      ...
      //get event session count
      $whereEvent           =  array('eventId' => $projectId);
	...
	<div class="width100_per mt40  defaultP">
		...
		<div class="fl">
			...
			<p class="pt5"><b>Event</b></p>
		</div>
		<ul class="total fr">
			<li class="clearb" >
				<span class="display_cell p_head"> <span class="fs16 font_bold minwidth_165 ">Event Showcase</span>
    ...
    <input type="hidden" name="<?php echo $userContainerId; ?>_industrySection" value="Event">
