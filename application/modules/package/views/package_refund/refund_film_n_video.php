<div id="divCounter<?php echo $divCounter; ?>" class="<?php echo ($divCounter=="1")?'':'dn'; ?>" >
  ...
  <h3 class="red  fs21 fnt_mouse bb_aeaeae"><?php echo $this->lang->line('pack_refund_FvElement_heading'); ?></h3>
  ...
  <?php 
    ...
    foreach($projectDataList as $projectdata){
      ...
      //get film & video album content 
      $projectElementData      =  getDataFromJoinTabel('FvElement',$projectId);
      ...
      if(!empty($projectElementData)){
        foreach($projectElementData as $projectElement){
          if($projectElement['default']=="t"){
            $extractsCount++;
          }if($projectElement['default']=="f"){
            $videosCount++;
          }
        }
      }
  ...
  ?>
	...
	<div class=" width100_per mt40  defaultP">
        ...
        <div class="bb_F1592A display_block width100_per fl  mb5 pb4">
           ...
           <div class=" fr text_alignR fs13 font_weight lineH20 ">
              <p class="red">Film &amp; Video Collection</p>
        ...
        <ul  class=" fs13 collabration_wrap pt18 clearb fl width100_per">
           ...
           <li class="width152 bdrR_c3c3c3 bdrL_c3c3c3">
             ...
             <span > <b class="red fs14"><?php echo $videosCount;  ?></b> Videos</span> <span class="sap_10"></span> 
             <span > <b class="red fs14"><?php echo $extractsCount;  ?></b> Extracts </span> </li>
    ...
    <input type="hidden" name="<?php echo $userContainerId; ?>_industrySection" value="Film & Video">
