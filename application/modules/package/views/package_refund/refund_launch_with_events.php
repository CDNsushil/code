<div id="divCounter<?php echo $divCounter; ?>" class="<?php echo ($divCounter=="1")?'':'dn'; ?>">
  ...
  <h3 class="red  fs21 fnt_mouse bb_aeaeae"><?php echo $this->lang->line('pack_refund_launch_with_events_heading'); ?></h3>
  ...
  <?php 
    ...
    foreach($projectDataList as $projectdata){
      ...
      $projectTitle               =  (!empty($projectdata['eventtitle']))?$projectdata['eventtitle']:'';
      ...
      $startDate                  =  (!empty($projectdata['StartDate']))?$projectdata['StartDate']:'';
      ...
      $type                       =  (isset($projectdata['eventtype']))?$projectdata['eventtype']:'0';
      ...
      $whereEvent           =  array('eventId' => $projectId,'launchEventId !=' => '0');
	...
	<div class="width100_per mt40  defaultP">
		...
		<div class="fl">
			...
			<p class="pt5"><b>Launch with Event</b></p>
		</div>
		<ul class="total fr">
			<li class="clearb" >
				<span class="display_cell p_head"> <span class="fs16 font_bold minwidth_165 ">Launch with Events Showcase</span>
    ...
    <div class=" width100_per mt60 defaultP">
     ...
     <div class="collaborat_wrap pl15 pr15 pt8 pb15 fr width_545 shadow_light bdr_c3c3c3">
        <div class="bb_F1592A display_block width100_per fl  mb5 pb4">
           ...
           <div class=" fr text_alignR fs13 font_weight lineH20 ">
              <p class="red">Launch with Event</p>
     ...
     <div class="display_table fr width_545 pr10 red fs16">
        <ul class="display_block collb_list pt25">
           <li><span class="fl"> Launch with Events Showcase per annum</span> <span class="fr"> 
             <?php 
    ...
    <input type="hidden" name="<?php echo $userContainerId; ?>_industrySection" value="Launch with Event">
