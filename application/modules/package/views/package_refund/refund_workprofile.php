<div id="divCounter<?php echo $divCounter; ?>" class="<?php echo ($divCounter=="1")?'':'dn'; ?>" >
  ...
  <h3 class="red  fs21 fnt_mouse bb_aeaeae"><?php echo $this->lang->line('pack_refund_workprofile_heading'); ?></h3>
  ...
  <?php 
    ...
    foreach($projectDataList as $projectdata){
      ...
      $projectTitle               =  (!empty($projectdata['synopsis']))?$projectdata['synopsis']:'';
      ...
      $projPublisheDate           =  (!empty($projectdata['dateCreated']))?$projectdata['dateCreated']:'';
      ...
      $industryName               =  (isset($projectdata['IndustryName']))?$projectdata['IndustryName']:'0';
      ...
      $dirname               =   'media/'.LoginUserDetails('username').'/workProfile/';
	...
	<div class="width100_per mt40  defaultP">
		...
		<div class="fl">
			...
			<p class="pt5"><b>Product Classified</b></p>
		</div>
		<ul class="total fr">
			<li class="clearb" >
				<span class="display_cell p_head"> <span class="fs16 font_bold minwidth_165 ">Product Classifieds Showcase</span>
    ...
    <div class=" width100_per mt60 defaultP">
     ...
     <div class="collaborat_wrap pl15 pr15 pt8 pb15 fr width_545 shadow_light bdr_c3c3c3">
        <div class="bb_F1592A display_block width100_per fl  mb5 pb4">
           <h4 class="font_museoSlab fl mt6"><?php echo substr($projectTitle, 0, 50); ?></h4>
           <div class=" fr text_alignR fs13 font_weight lineH20 ">
              <span> <span class="red"> Work Profile </span> </span>
        ...
        <ul  class=" fs13 collabration_wrap pt18 clearb fl width100_per">
           <li class="width_141"> <span class="pb9">Published<br />
             <?php echo dateFormatView($projPublisheDate,'d F Y'); ?>  </span> 
             <span class="">Storage Space Used <b class="red"><?php echo $usedSpaceSize; ?> MB</b> </span>
           </li>
     ...
     <div class="display_table fr width_545 pr10 red fs16">
       <ul class="display_block collb_list pt25">
           <li><span class="fl">Work Profile per annum</span> <span class="fr"> 
             <?php 
    ...
    <input type="hidden" name="<?php echo $userContainerId; ?>_industrySection" value="Work Profile">
