...
<div id="divCounter<?php echo $divCounter; ?>"  class="<?php echo ($divCounter=="1")?'':'dn'; ?>">
  <h3 class="red  fs21 lettr_spacing-2 whitespace_now bb_aeaeae"><?php echo $this->lang->line('pack_refund_collaborations_heading'); ?></h3>
  ...
  <?php 
    ...
    foreach($projectDataList as $projectdata){
      ...
      $dirname               =   'media/'.LoginUserDetails('username').'/collaboration/'.$projectId.'/';
      ...
      //get files count data of collaboration media 
      $projectElementData     =  getCollaborationMediaList($projectId);
      $videosCount   = 0;
      $audioCount    = 0;
      $pdfCount      = 0;
      //count of files
      ...
      if(!empty($projectElementData)){
        foreach($projectElementData as $projectElement){
          if($projectElement['fileType']=="2"){
            $videosCount++;
          }elseif($projectElement['fileType']=="3"){
            $audioCount++;
    ...
    // get collaboration entries count
    $whereMember                =  array('collaborationId' =>$projectId,'status'=>'1');
    $collaborationMembersData   =  getDataFromTabel('CollaborationMembers', 'memberId',  $whereMember, '', $orderBy='memberId', $order='ASC');   
	...
	<div class="width100_per mt40  defaultP">
		...
		<div class="fl">
			...
			<p class="pt5"><b>Collaboration</b></p>
		</div>
		<ul class="total fr">
			<li class="clearb" >
				<span class="display_cell p_head"> <span class="fs16 font_bold minwidth_165 ">Collaboration Showcase</span>
    ...
    <div class=" width100_per mt60 defaultP">
     ...
     <div class="collaborat_wrap pl15 pr15 pt8 pb15 fr width_545 shadow_light bdr_c3c3c3">
        ...
        <ul  class=" fs13 collabration_wrap pt18 clearb fl width100_per">
           <li class="width_141"> <span class="pb9">Published<br />
             <?php echo dateFormatView($projPublisheDate,'d F Y'); ?>  </span> <span class="pb9">Active members<br />
              <b class="red"><?php echo (!empty($collaborationMembersData))?count($collaborationMembersData):'0'; ?> </b> </span> <span class="">Storage Space Used <b class="red"><?php echo $usedSpaceSize; ?> MB</b> </span>
           </li>
     ...
     <div class="display_table fr width_545 pr10 red fs16">
        <ul class="display_block collb_list pt25">
           <li><span class="fl">Collaboration per annum</span> <span class="fr"> 
             <?php 
    ...
    <input type="hidden" name="<?php echo $userContainerId; ?>_industryType" value="Collaboration">
