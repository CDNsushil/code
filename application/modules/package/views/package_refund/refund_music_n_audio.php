<div id="divCounter<?php echo $divCounter; ?>" class="<?php echo ($divCounter=="1")?'':'dn'; ?>">
  ...
  <h3 class="red  fs21 fnt_mouse bb_aeaeae"><?php echo $this->lang->line('pack_refund_MaElement_heading'); ?></h3>
  ...
  <?php 
    ...
    foreach($projectDataList as $projectdata){
      ...
      //calculate container price and extra space price
      $containerTotalPrice    =  $containerPrice +  $ExtraSpaceTotalPrice; 
      
      //get songs count data 
      $projectElementData      =  getDataFromJoinTabel('MaElement',$projectId);
      $songsCount   = 0;
      //count of audio
  ...
  ?>
     ...
     <div class="collaborat_wrap pl15 pr15 pt8 pb15 fr width_545 shadow_light bdr_c3c3c3">
        <div class="bb_F1592A display_block width100_per fl  mb5 pb4">
           ...
           <div class=" fr text_alignR fs13 font_weight lineH20 ">
              <p class="red">Music Collection</p>
        ...
        <ul  class=" fs13 collabration_wrap pt18 clearb fl width100_per">
           ...
           <li class="width152 bdrR_c3c3c3 bdrL_c3c3c3"><b class="fs14 fl pb10 clearb">Album Contents</b> 
           <span > <b class="red fs14"><?php echo $songsCount; ?></b> Songs</span>
    ...
    <input type="hidden" name="<?php echo $userContainerId; ?>_industrySection" value="Music & Audio">
