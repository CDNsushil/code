...
$packageStage4_2 = array(
  'name'=>'packageStage4_2',
  'id'=>'packageStage4_2'
);
...
<?php echo form_open($this->uri->uri_string(),$packageStage4_2); ?>
                   ...
                   <div class="TabbedPanelsContent TabbedPanelsContentVisible">
                      <div class="wra_head clearb">
                        ...
                        <?php 
                          ...
                          $data['backUrl']   = base_url('package/membershipselected');
...
<script>
  ...
  $("#packageStage4_2").validate({
    ...
    submitHandler: function() {
        var formPostUrl = "/package/billingdetailspost";
        var formData =$("#packageStage4_2").serialize();
        $.ajax({
            type: 'POST',
