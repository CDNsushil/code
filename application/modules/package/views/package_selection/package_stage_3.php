...
<script>
   ...
   */
    ...
    $('.emailCheck').blur(function(){
        ...
        if(errorStatus==false){
             $.ajax({
                  ...
                  beforeSend:function(){
                      //show loader
                      $("#emailAvailMsg").show().html('<img  class="ma ajax_loader" align="absmiddle"src="'+baseUrl+'images/loading_wbg.gif" />');
                  },
                  complete:function(){
                  ...
                  success:function(data){
                    ...
                    if(data.errorStatus){
                        ...
                        $('#emailAvailMsg').show().html(data.errorMessage);
    ...
    $('#email').keyup(function(){
		var emailmsg = $('#emailAvailMsg').html();
		var emailval = $('#email').val();
		var emailcheck = $("label[for=email]").text();
        if((emailmsg != "" && emailval == "") || (emailcheck != ""))
		{
			$('#emailAvailMsg').html('');
		}
		});
