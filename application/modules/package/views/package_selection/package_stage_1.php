...
if($freePackageChecked || $oneYearChecked || $threeYearChecked){
  $joinFreeButton = array(
    ...
    'class'   =>  'b_F1592A selectPackage mt30 disable_btn',
    'type'    =>  'button',
  );
}else{
  $joinFreeButton = array(
    ...
    'class'   =>  'b_F1592A selectPackage mt30 ',
    'type'    =>  'submit',
  );
}
         ...
         <div class="TabbedPanelsContentGroup main_tab m_auto membership_info  display_table ">
            <div class="TabbedPanelsContent TabbedPanelsContentVisible">
               ...
               <table width="834" border="1" class="m_auto membership_table font_arial">
                  <tr>
                    <th> 
                         <span class="red bb_F1592A  bt_F1592A fs33 lineH41 pb5 letter_spP7 opens_light" >
							 Membership Options</span> <span class="fs26 pt20 pl7 opens_light lineH31"> 
							 <span class="whitespace_now"> Join for FREE and<br />
                        connect to your<br />
                        favourite creatives.</span> <span class="pt13 lettspace_M1_2">Try our Annual or <br />
                        3-year Memberships<br />
                        with a month's trial</span> </span> <span class="pt20 fs15 s_italic lineH26 ">Roll over to see more details. 
                     ...
                     <th >
                       ...
                       <div class="fs19 pt25 opens_light lett4"> <span> Create your online <br />
                           ...
                           additional sections.</span> <span class="pt15 lettspace_M1_2">Unlimited, effortlass 
                          editing. </span> 
                        </div>
                     ...
                     <th>
                        ...
                        <span class="fs20 pt20 opens_light lett4 pb3"> <span class="lettspace_M_5"> Grow your Showcase,<br />
                        with unlimited sections </span><br />
                        and<span class="red fs30 pt5 mb8 pl10">50 GB</span> <span>of storage space.</span></span>
						<span class="fs20 lett4 pb10 pt5"><?php echo $lblAboveBtn;?></span>
						
                       <?php 
                            $buttonData['oneYearChecked']  		  = $oneYearChecked;
                            $buttonData['threeYearChecked'] 	  = $threeYearChecked;
                            $buttonData['buttonPositionClass'] 	= '';
                  ...
                  <tr>
                     <td> Events
                        ...
                        <!-- Events popup start-->
						<div class="member_popup coming_wrap pl36 pt17 pb28 pr30  text_alighL position_absolute">
							<span class="pop_arrow arrw fl position_absolute"><img src="<?php echo $imgPath; ?>/arrow_left.png" alt="" /></span>
							<div class="fl width_307 pr20"> 
							...
							<div class="cooming_pop"><img src="<?php echo $imgPath.'mem_coming.png';?>" alt="" /></div>
						</div>
                  ...
                  <tr>
                     <td> Work Profile & Portfolio
                     
                        <!--Work Profile & Work Profile App.  popup start-->
							<div class="member_popup pl36 pt17 pb28 pr30 width_307 text_alighL position_absolute">
							    <span class="pop_arrow arrw fl position_absolute"><img src="<?php echo $imgPath; ?>/arrow_left.png" alt="" /></span>
							   <h4 class="fs21 red bb_F1592A">Work Profile & Portfolio </h4>
               ...
               <ul class="btn_wrap fr">
                  ...
                  <li>
					  <span class="fs20 lett4 "><?php echo $lblAboveBtn;?></span>
                    <?php
                        $buttonData['buttonPositionClass'] 	= 'pt12';
                        $this->load->view('common_view/package_upgrade_button',$buttonData);
                    ?>
                  </li>
               </ul>
