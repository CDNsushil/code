...
<?php echo form_open($this->uri->uri_string(),$renewStage3_2); ?>
                     ...
                     <div class="TabbedPanelsContentGroup ">
                           <div class="TabbedPanelsContent width635 TabbedPanelsContentVisible">
                              ...
                              <ul class="total  purcharse clearb mt40" >
                                 ...
                                 <li class="clearb space_1 BB_dadada" >
                                  ...
                                  <?php 
                                    ...
                                    $campaignTotalPrice =  multiarraysum($selectedCampaignList,'totalPrice');
                                  ?>
                                     
                                      <li class="clearb  BB_dadada" >
                                        <span class="display_cell p_head ">  <span class="fs16 font_bold minwidth_165"><?php echo $this->lang->line('renew_selected_campaign_price'); ?></span> 
                                       </span>
                                        <span class="price "> <?php echo '€ '.number_format($campaignTotalPrice,2); ?> </span> 
                                     </li>
                                  ...
                                  <?php 
                                    //------------extra space price-------------------//
                                    // default price of extra space 
                                    $extraSpaceTotalPrice = 0;
                                    if(!empty($extraSpaceItemList)){ 
                                    $extraSpaceTotalPrice =  multiarraysum($extraSpaceItemList,'totalPrice');
                                  ?>
                                  
                                     <li class="clearb  BB_dadada" >
                                        <span class="display_cell p_head ">  <span class="fs16 font_bold minwidth_165"><?php echo $this->lang->line('renew_extra_space_price'); ?></span> 
                                        <span class="fs13 font_notmal pl5">200 MB</span></span>
                                        <span class="price "> <?php echo '€ '.number_format($extraSpaceTotalPrice,2); ?> </span> 
                                     </li>
                                 ...
                                 <li class="clearb BT_dadada" >
                                    ...
                                    <span class="price red font_bold">  
                                        <?php 
                                            $totalPrice    =  $membershipPrice +  $VatPrice + $campaignTotalPrice + $extraSpaceTotalPrice;
                              ...
                              <div class="bill_detail clearb color_666 ">
                                 ...
                                 <p>
                                     <a href="<?php echo base_url('package/renewbillingdetails'); ?>">
...
<script>
   ...
   */
   $("#renewStage3_2").submit(function(){
     
       var getChkStatus= $('#paymentTermCondition').is(":checked");
       if(getChkStatus){
          $('#payment_term_error').hide();
          window.location.href="<?php echo base_url(lang().'/membershipcart/payments_pro/packagerenew') ?>";		
       }else{
