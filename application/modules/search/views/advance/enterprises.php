...
<a href="<?php echo $search->link;?>" target="_blank" >
    <div class="search_box heightauto">
        <span class="table_cell width_235 text_alighC busniess_w"><img alt="" src="<?php echo $search->searchImage;?>"></span>
        <div class="table_cell text_alighL fr width342  ">
            ...
            <div class=" font_bold pt12 pb12 pl10 pr10  BT_dadada pr3"> 
                <span class="opens_light fs23 lineH16 clr_004a80 "><?php echo $this->lang->line('business');?></span>
