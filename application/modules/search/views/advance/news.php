...
<a href="<?php echo $search->link;?>" target="_blank" >
    <div class="search_box">
        ...
        <div class="bgf4f4f4 pt8 pb5 display_table  lettsp-1 width100_per"><b class="fr  pr20 "><?php echo $search->creative_name;?></b>  </div>
        ...
        <div class="fl search_title_img  display_table bdr_non">
            <span class="table_cell"><img alt="" src="<?php echo $search->searchImage;?>"></span>
            <span class="fs13 pl10 pr10 title_creav font_bold"><?php echo $this->lang->line('newsCollectionHeading');?></span>
        </div>
    </div>
</a>
