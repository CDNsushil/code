        ...
        <?php echo form_open(base_url(lang().'/tmail/replyTmail'),$formAttributes); ?>
          ...
          <div class="fl width770">
                   ...
                   <?php
                    //Set attachment of tmail start here
                     if(!empty($attachmentData->fileId) && !empty($attachmentData->filePath) && !empty($attachmentData->fileName) && file_exists(ROOTPATH.$attachmentData->filePath.$attachmentData->fileName)) {?>
                        <p class="fr red">
                                <a class="" href="<?php echo base_url().$attachmentData->filePath.$attachmentData->fileName;?>" original-title="Download" download="<?php echo $attachmentData->rawFileName;?>">
                                    <button type="button" class="fr red "><?php echo $attachmentData->rawFileName;?> </button>
                                </a>
                           </p>
                    <?php }
             ...
             <div class="width677 fr">
                 ...
                 <a href="<?php echo base_url_lang('showcase/index/'.$data->get_sender_id); ?>" target="_blank" class="fl mt20 ml36 clr_0072bc"> View Showcase > </a>
