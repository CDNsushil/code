...
//echo $sql;	die;
  ...
  function getCount($user_id){
	...
	function getMinNo($user_id,$type='Inbox'){
		...
		function getcravedUser($user_id,$sort=''){
            ...
            if($this->input->post("userType")){
                $sort     =  $this->input->post("keyWords");
                $userType =  $this->input->post("userType");
                
                switch($userType){
                    case "creative":
                        $whereCondi = ' AND u."creative" = \''.$isFlage.'\'';
                    break;
                    
                    case "professionals":
                        $whereCondi = ' AND u."associatedProfessional" = \''.$isFlage.'\'';
                    break;
                    
                    case "business":
                        $whereCondi = ' AND u."enterprise" = \''.$isFlage.'\'';
                    break;
                    
                    case "fans":
                        $whereCondi = ' AND u."fans" = \''.$isFlage.'\'';
                    break;
                }
           ...
           if(isset($sort) && $sort!='' && $sort!='Keywords') {             
	...
	/* End */	
		...
		function trashordeletetmail($Id,$isTrash){	
