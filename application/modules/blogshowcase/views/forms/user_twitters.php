...
<div class="pt25 bg_fff fl width100_per pb20"> 
	<div class=" pl35 pr25">
		<p class="gotham_r fs18"><?php echo $this->lang->line('recentTweets'); ?></p>
		<span class="sap_30"></span>
		<div class="scroll_box mt11 innershadw backgroundBlack">
			<div class="slider" id="twitterSlider">
				...
				<div class="viewport scroll_container02 c5c5c5 width270px">
					<div class="row recent_box_wrapper01 height235 mb4">
						<ul class="overview twitter_list height480 top0px" >		
							<?php
							$ptrclass='';
							$function = '';
							$url = '';
							...
							{					
								...
								?>
								<li>
								<div class="fs12 pt10 open_sans bb_d5d5 clearbox pb5">				
									<p class="clr_240227" <?php echo $function;?> >
										<?php echo getSubString($twitvalue['text'],75);?>
										<a href="<?php echo $onclickShortUrl;?>" class="red"> <?php echo $url;?></a>
									</p>
									<span class="fr fs11 clr_888 pt8"><?php echo date($date_format,$tweet_time);?></span>
								</div>
								</li>	
							<?php 					
							}						
