...
<?php if($designtypeshow==1){
    ...
    if(previewModeActive()){
        $funtionAction = "customAlert('".$this->lang->line('Youcannotbuyfromyourselfpreview')."')";
    }else{
        $funtionAction = "loadPopupData('popupBoxWp','popup_box',shippingData)";
    }
    
?>
<!--<p class="fs11 clearb mt10">This Album contains physical goods that will be shipped to you.</p>-->
<a class="btn_review mt3 <?php echo ($showview=='project')?"fl clearb":"fr clearb"; ?>  fs13" href="javascript:void(0)" onclick="<?php echo $funtionAction; ?>">Shipping Charges</a>
<?php  } ?>
