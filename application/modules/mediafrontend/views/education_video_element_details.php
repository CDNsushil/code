...
<div class="row content_wrap" >
    ...
    <div class="banner_collection mb15 " >
       ...
       <div class="width908 display_table m_auto pb8">
          <h2  class="font_bold lineH22 width650 fl"><?php echo $title;?></h2>
       ...
       <!--==================  banner start ============-->
        <div  class="flexslider">
           <div class="display_table m_auto bdr_a1a1a1 collection_banner height564">
              <div class="table_cell height564"> 
