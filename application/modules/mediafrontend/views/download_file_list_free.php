...
<div class="row content_wrap blog_wrap" >
   ...
   <div class="m_auto display_table wid940">
      ...
      <button class="fr mr15 bg_f1592a bdr_aca height32 all_file_download"><span class="download_file pr20 mr10 ">Download All Video Files </span>| 
         ...
         <?php
            ...
            foreach($elements as $e=>$element){
                ...
                if(is_file($file)){
                    ...
                    ?>	
                     <div class="border_cacaca p10 wid920 display_inline_block row bg_f7f7f7 mb10 filesize">
