<?php if ( ! defined('BASEPATH')) exit('No direct script access allowed'); 
    ...
    //check preview true then default should published
    $isPublishedElement        =  (previewModeActive())?"t":$isPublishedElement;
    ...
    $globalElementIsPublished        =  (previewModeActive())?"t":"f";
    ...
    $priceBtnDetails                =   array(
        ...
        if($projSellstatus){
            if($projSellType==1){
                ...
                //old variable $isprojDownloadPrice
                //fixed price code here
                //1:A Price for the Collection,2:A Price for each Piece and Collection, 3: Price for the each piece
                if($hasDownloadableFileOnly==1 && $isDownloadPriceElement=='t'  && ($sellPriceType==3 || $sellPriceType==2)){
