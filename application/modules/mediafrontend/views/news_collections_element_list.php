    ...
    if(!empty($elementDataList)){
     ?>
      <div class="clearbox bg6c6c pt20 pb20 ">
         <h2 class="fs29 pl18 clr_fff lineH24"><?php echo $this->lang->line('news_article_list'); ?></h2>
      </div>
        ...
        <?php 
            ...
            foreach($elementDataList as $elementData){
               ...
               //print_r($elementData);
                ...
                $articleLink       =     'mediafrontend/articledetails/'.$frentendUserId.'/'.$projectId.'/'.$elementId.$previewWord;
                        
        ?>
            <a href="<?php echo $articleLink; ?>" >
                <div class="review_box <?php echo ($n%2)?'':'bg_fff'; ?>">
                    <div class=" table_cell width650 pt13 pb9 pl20 text_alighL verti_top">
                    ...
                    <div class="img_news table_cell"> <img src="<?php echo $elementImage; ?>" alt="news"  /> </div>
                 </div>
            </a>
         <?php $n++; } ?>
