...
if($loggedUserId > 0){
                    ...
                    $reviewInformation=$this->load->view('media/reviewFormNew',array('enterPriseName'=>$enterPriseName,'industryId'=>$industryId,'elementId'=>$elementId,'entityId'=>$entityId,'isProject'=>$isProject),true);
