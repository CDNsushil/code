				...
				<td>
					<div class="height800ScrollY">
						...
						<div class="font_opensans font_size14 clr_444">
							...
							Filling in the fields in the Project section of Further Description creates your "cover": Your online equivalent of a DVD cover. In Further Description you can also tailor how each Piece will look on its Showcase page.
							<div class="seprator_13"></div>
							When you have finished adding content go to the Competition Entry Index page and after you are after you are happy with how your work looks in Preview, press Publish.
							<div class="seprator_13"></div>
						...
						<div class="width_476 pl32 pr20" id="Sell">
							...
							<div class="font_opensans font_size14 clr_444 howpub_discrip">
								...
								<div class="sale_instruction">
								<ul class="ml30">
									<li><span>Fill in your <a class="ulLink" href="<?php echo base_url('dashboard/globalsettings');?>">Seller Settings</a> in your Global Settings page on your Dashboard. </li>
								...
								<div class="seprator_10"></div>
								<ul class="ml40">
									<li>You can put up an Extract and two Trailers to advertise you on-sale work. These will be seen on your Showcase, as will Pieces you add using Embed rather than Upload.</li>
									<li>You can combine 3 types of sales: Download, Pay-Per-View (PPV) and shipped Product. </li>
									<li>To sell you must set at least one Project price and you must Upload at least one Piece.</li>
									<li>In a Collection you can also offer a Piece for individual sale, if you uploaded it.</li>
									<li>Downloads and PPV are available to Buyers for 7 days.</li>
