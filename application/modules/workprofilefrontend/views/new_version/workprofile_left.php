...
//$workProfileThumbImage = addThumbFolder($profileImgPath.$profileImgName,'_l');
...
?>
<div class="left_profile fl">
   <h2 class="fs24 fl whitespace_now"><?php echo $profileFName.' '.$profileLName ?></h2>
	...
	$this->load->view('new_version/portfolio_common_button',$buttonArray); 
	?>
</div>	
