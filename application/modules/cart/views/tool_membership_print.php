...
<table width="615" cellspacing="0" cellpadding="0" border="0" align="center" style="margin-bottom:100px; font-size:12px;">
    ...
    <table border="0" style="background:#f7f8f8; width:615px; padding-top:22px; padding-bottom:24px; padding-left:10px; padding-right:10px;"  bgcolor="#fafafb">
                <tr>
                    <td width="200" style="font-weight:bold; padding-left:48px;"><?php echo $this->lang->line('invoice_item_des'); ?></td>
                    <td width="90" style="font-weight: bold; text-align: right; padding-right: 10px;"><?php echo $this->lang->line('invoice_item_size'); ?></td>
                ...
                <tr>
                    <td colspan="5" ><table border="0" cellspacing="0" cellpadding="0" style="border:solid 1PX #000; padding:10px 15px; background:#ffffff; width:530px; margin:0 auto; box-shadow:0 0 3px #ccc; -webkit-box-shadow:0 0 3px #ccc; -moz-box-shadow:0 0 3px #ccc; ">
                            ...
                            <tr style="background:#f7f8f8;">
                                <td style="padding-right:24px; color:#666666;height:22px;vertical-align: middle;" width="220" valign="top"><?php echo $item_name; ?>  </td>
                                <td style="text-align:right; color:#666666;border-right:1px solid #ccc; vertical-align: middle;padding-right: 10px;" width="75" valign="top"><?php echo bytestoMB($membership_item->size + getItemSize($membership_item->memItemId)); ?> MB</td>

                                <td style="text-align:right; color:#666666;border-right:1px solid #ccc; vertical-align: middle;padding-right: 10px;" width="50" valign="top"><?php echo $this->lang->line('currency'); ?> <?php echo number_format($membership_item->basePrice + getItemAmount($membership_item->memItemId),2); ?></td>
                            ...
                            <tr>
                                <td style="text-align:right; color:#666666;padding-top:40px; padding-right:30px;height:25px;" colspan="4"><?php echo $this->lang->line('invoice_consumption_tax'); ?> <font style="font-weight:bold; padding-left:5px;"><?php echo $this->lang->line('invoice_VAT'); ?> <?php echo $vat_percent; ?>%</font></td>
                                <td colspan="1" style="text-align:right; color:#666666; padding-top:40px; padding-right:0px;"><?php 
                                    echo $vat_value;
                                     ?></td>
                            </tr>
                            <tr >
                                <td style="text-align:right;border-top:1px solid rgb(241, 89, 33); color:#1e1e21; font-weight:bold; font-size:14px; padding:0 30px 15px;height:25px; " colspan="4"><?php echo $this->lang->line('invoice_total'); ?></td>
                         ...
                         //$mainAmount= $taxValue+$amountAdd;
                          $mainAmount= $membershipOrderDetails->totalPaid;
                           echo number_format($mainAmount,2); ?></td>
                            </tr>
                        </table></td>
                </tr>
            </table></td>
