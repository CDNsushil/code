...
<div class="sale_box shadow_light">
    ...
    <div class="half_box verti_top">
       <div class="fs18 green lineH30  bb_F1592A font_bold">Pay Per View Sale</div>
       ...
       <div class="sale_btnwrap">
            ...
            <button class="light_btn <?php echo $disabledClass; ?>" <?php echo $disabled; ?> onclick="openLightBox('popupBoxWp','popup_box','/cart/buyercomments','<?php echo $purchaseData->itemId; ?>');" type="button">Buyer’s Comment</button>
       </div>
    </div>
    <!-- Half box gary  --> 
