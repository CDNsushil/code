										 ...
										 <!--------shipping_details_div start----->    
										    <div id="shipping_details_div<?php echo $formId; ?>">
												...
												?>	
													...
													<div class="show_shipping_note ml10 mt6">
														* Please let the Seller know when you receive the item.
													 </div>
													
													<div class="cartbtn_pur ml10 mt6 fr">
														<a style="background-position: 0px 0px;" onclick="shipping_details_submit('<?php echo $formId; ?>')" onmouseup="mouseup_tds_button_pur(this)" onmousedown="mousedown_tds_button_pur(this)"><span style="background-position: right 0px;">Received</span></a> 
													</div>
