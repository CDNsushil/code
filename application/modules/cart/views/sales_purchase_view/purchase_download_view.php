...
<div class="row ml28 mr28 mt7 bdr_cecece pr">
                    	<div class="fl SCart_item_purchaseleft">
                        	<div class="width384px  SCart_item_inner_purchase position_relative pt8 pb5 lineh_20 clr_666 font_opensans">
									...
									<div class="row">
                                    	<div class="fl width119px text_alignR">Download Period</div>
                                ...
                                <div class="row">    
										<div class="cartbtn_pur ml10 mt6 fr <?php echo $disable;?>"> <a <?php echo $traget;?>  href="<?php echo $downloadLink;?>" onmouseup="mouseup_tds_button_pur(this)" onmousedown="mousedown_tds_button_pur(this)"><span class="orange_clr_imp">Download</span></a> </div>
								</div>	
							<div class="clear"></div>
