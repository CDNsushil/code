...
if($totalRecords > 0)
{
	$isAnyItemBlocked=isAnyItemBlocked($listData,false);
...
<div class="row clear seprator_10"></div>
			   ...
			   <div class="cell blog_right_wrapper">
                  <div class="blog_link2_wrapper">
					...
					if($isBlocked != 't' && $isExpired != 't'){ ?>
						  <a class="formTip" href="javascript:void(0);" title="<?php echo $this->lang->line('restore');?>" onclick="moveFromArchive('','Events','EventId','<?php echo $maineventid; ?>','EventArchive','/event/eventnotifications/notificationslist/deleted/','');"><span><div class="restore_btn_icon"></div></span></a>
						<!--<a class="formTip" href="javascript:void(0);" title="<?php //echo $this->lang->line('unArchive');?>" onclick="moveFromArchive('','Events','EventId','<?php //echo $maineventid; ?>','EventArchive','/event/eventnotifications/notificationslist/deleted/','');"><span><div class="blogUnArchiveIcon"></div></span></a>-->
						<?php
					}
					if($isBlocked != 't'){?>
						<a href="javascript://void(0);" class="formTip" onclick="deleteTabelRow('Events','EventId','<?php echo $maineventid; ?>','','','','<?php echo $value['FileId'];?>','<?php echo $imagePathForEvent;?>',1,'',1,'<?php echo $this->lang->line('sureDelMsg') ?>')"  title="<?php echo $this->lang->line('delete');?>"><span><div class="projectDeleteIcon"></div></span></a> 
						<?php
					} ?>
					</div>   
                    <!--icon_edit_blog-->
