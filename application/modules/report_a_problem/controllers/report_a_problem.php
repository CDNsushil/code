...
class Report_a_problem extends MX_Controller{
	...
	function index(){
		...
		$this->new_version->load('new_version','report_a_problem/reportproblem_step1',$this->data);
	}
	/**
	...
	{  
		...
		if($data['abusiveType']==3)
		{
			...
			{  
				...
				{
					$messageData['showMessage']= "Your message <br> has been sent";
                    echo $this->load->view('message_show_view',$messageData);
				}
				else
				{
					$messageData['showMessage']= "Error during <br> save abusive <br> report data";
                    echo $this->load->view('message_show_view',$messageData);
				}
			}
			else
			{
				$messageData['showMessage']= "No Element <br> Found";
                echo $this->load->view('message_show_view',$messageData);
			}
		}
		else
    ...
    function test(){
        $this->new_version->load('new_version','message_show_view');
    }
