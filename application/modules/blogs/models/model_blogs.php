...
Class model_blogs extends CI_Model {
	...
	**/
	function getMainPosts($userId=0,$blogId=0,$industryId=0,$catId=0, $limit=0, $offset=0){
		...
		$this->db->select($this->postTable.'.postId,'.$this->postTable.'.postTitle,'.$this->postTable.'.postOneLineDesc,'.$this->postTable.'.custId,'.$this->postTable.'.postFileId,'.$this->postTable.'.dateCreated,'.$this->postTable.'.dateModified,'.$this->postTable.'.isUserProfileImage');
