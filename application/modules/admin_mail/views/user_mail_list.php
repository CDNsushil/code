<div class="contentcontainer">
	<div class="headings altheading">
		<h2><?php echo ucfirst($type_proccess);?> <?php echo $this->lang->line('admin_list');?></h2>
	</div>
	<?php
					...
					<th>
						<?php 
							foreach($arr_user as $user)
							{
							  ...
							  echo "<a href='".BASEURL."admin_mail/search_members/".$type_proccess."/".$user["value"]."' class='tooltipClass' title='".$this->lang->line('admin_search_by_user')." ".$user['value']."' >".$user["value"]."</a> | ";
							}
						?>
					</th>
				</tr>
				...
				if($users!=false){
					foreach($users as $users){?>
						<tr>
							...
							<td><?php echo "<a href='".BASEURL."admin/admin/user_profile/".$users->user_id."' class='user_css_rm'>".ucfirst($users->firstname)." ".$users->lastname."</a>";?></td>
