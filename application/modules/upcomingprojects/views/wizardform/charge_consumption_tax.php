...
<div class="TabbedPanelsContent Consumption_Tax TabbedPanelsContentVisible"> 
    <?php echo form_open($baseUrl.'/saveConsumptionTax/'.$projId,$formAttributes);?>                
		<div class="c_1">
			...
			<div class="defaultP clearb country_tab">
                ...
                <div class="fr btn_wrap display_block font_weight">
                    <a href="<?php echo site_url(lang().'/upcomingprojects/donation/'.$projId);?>" id="cancleForm"> 
		...
		$("#consumptionChargeForm").validate({
			submitHandler: function() {
				...
				if(stateList.length > 0) {
                    ...
                    $.post('<?php echo $baseUrl.'/saveConsumptionTax/'.$projId ?>',fromData, function(data) {
	...
	$('#next_consumption_charge_step').click(function() {
        ...
        if(isTaxSameForAllStats == 't') {
            ...
            if(stateList.length > 0) {
                ...
                ({
                    type: "POST",
                    url: baseUrl+language+'/upcomingprojects/consumptionStateTaxHtml/',
                    data: form_data,
