...
class Pagination_new_ajax {
    ...
    function paginate($isShowButton=true,$isShowNumbers=true,$showActiveNumberonly=false)
    {
           ...
           if($isShowNumbers){
                ...
                for($i=1;$i<=$this->num_pages;$i++) {
                    ...
                    if($i==1 Or $i==$this->num_pages Or in_array($i,$this->range)) {
                        ...
                        if(isset($showActiveNumberonly) && ($showActiveNumberonly === true)){
                            $this->return .= ($i == $this->current_page And @$_REQUEST['page'] != 'All') ? "<a data-isdisabled=\"1\" data-page=\"$i\" data-ipp=\"$this->items_per_page\" class=\" pagingActiveTab\" href=\"javascript:void(0);\"><span class=\" pagination\">$i</span></a> ":"";
                        }else{
