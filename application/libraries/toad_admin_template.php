...
class Toad_admin_template 
{
	...
	{   
		...
		{	
			...
			/* -- Tips Drag-Drop -- */
			if($currentModule == 'manage_tips' || $currentModule == 'manage_categories'){	
			...
			if($view == 'manage_countries/country_listing' || $view == 'manage_eu_countries/country_listing' || $view == 'manage_state/state_listing' || $view == 'manage_templates/manage_templates_list' || $view == 'manage_suggestions/manage_suggestions_list' || $view == 'manage_templates_list' || $view == 'manage_genre/genre_listing' || $view == 'manage_continent/continent_listing' || $view == 'manage_lang/lang_listing' || $currentModule == 'manage_tips' || $currentModule == 'manage_categories'){
