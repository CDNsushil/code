	...
	<div class="bg_f3f3f3 pall8">
		...
		<div class="seprator_25"></div>
			<div class="row">
				...
				<ul>
					<li class="firsthild"><a href="javascript:void(0)" class="active"> Press Releases </a> </li>
					<li class="width_120"><a href="<?php echo base_url(lang().'/news/index');?>" >In The News </a> </li>
				...
				if(isset($press_listing['get_num_rows']) && $press_listing['get_num_rows'] > 0)
				{
					foreach($press_listing['get_result'] as $k=>$press_lists){ 
						...
						<div class="row font_opensansSBold font_size13">
							...
							<a href="<?php echo base_url('pressRelease/details/'.$press_lists['id']);?>"><?php echo $press_lists['title'];?></a>
							<div class="clear"></div>
							</div>
							<div class="clear"></div>
						</div>
