...
<div id="wrapperL">
	...
	<div class="box menu">
		...
		<a href="<?php echo site_url(SITE_AREA_SETTINGS.'manage_eu_countries/manage_country');?>"><?php echo $this->lang->line('createCountry');?></a>
	</div>
...
function update_status(countryId,status)
{
	...
	({
		type: "POST",
		url: BASEPATH+"/manage_eu_countries/updateCountryStatus",
		data: form_data,
		success: function(res)
		{	
			window.location.href=BASEPATH+'manage_eu_countries';
		}
	});
}
</script>
