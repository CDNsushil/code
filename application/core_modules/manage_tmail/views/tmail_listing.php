<?php  if ( ! defined('BASEPATH')) exit('No direct script access allowed'); ?>
	...
	?>
		<div class="ver_contact_wp parent">
			<a href="<?php echo site_url().'admin/settings/manage_tmail/view_message/'.$messageLogDetail['id'];?>">	
        ...
        <div class="tds-button-top modifyBtnWrapper pr20 mt18">
			<a original-title="Delete" href="<?php echo base_url().SITE_AREA_SETTINGS.'manage_tmail/delete_msg/'.$messageLogDetail['id'];?>" class="formTip ml6" onClick="return confirm('Are you sure you want to delete?')"><span><div class="projectDeleteIcon"></div></span></a> 
		</div>
	...
	if(isset($items_total)  && isset($items_per_page) && $items_total >  $items_per_page){?>
			...
			<div class="pt15 ml28 mt7 mr15">
				<?php $this->load->view('pagination',array("pagination_links"=>$pagination_links,"items_total"=>$items_total,"items_per_page"=>$items_per_page,"url"=>base_url('admin/settings/manage_tmail/index'),"divId"=>"showUserList","formId"=>0,"unqueId"=>"full","isShowNumber"=>true,"isShowDD"=>true,"pagingWpaerClass"=>'pagination_wrapper new_page_design')); ?>
		</div>
		<div class="clear"></div>
	<?php } ?>
