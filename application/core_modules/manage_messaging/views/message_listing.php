<?php  if ( ! defined('BASEPATH')) exit('No direct script access allowed'); ?>
	...
	?>
		<div class="ver_contact_wp parent">
			<a href="<?php echo site_url().'admin/settings/manage_messaging/view_message/'.$messageLogDetail['id'];?>">	
        ...
        <div class="tds-button-top modifyBtnWrapper pr20 mt18">
			<a original-title="Delete" href="<?php echo base_url().SITE_AREA_SETTINGS.'manage_messaging/delete_msg/'.$messageLogDetail['id'];?>" class="formTip ml6" onClick="return confirm('Are you sure you want to delete?')"><span><div class="projectDeleteIcon"></div></span></a> 
		</div>
