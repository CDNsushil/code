...
<div id="uploadElementForm<?php echo $browseid;?>" class="width320px fr dn" >
	...
	<form enctype="multipart/form-data" toggledivform="uploadElementForm<?php echo $browseid;?>" id="uploadmediaForm<?php echo $browseid;?>" name="uploadmediaForm" accept-charset="utf-8" method="post" action="<?php echo base_url(lang().'/pressRelease/add_edit_PressReleaseNewsMaterial');?>" novalidate="novalidate">							
		...
		<div class="clear"></div>
		<div class="pl45" >
				<div class="tds-button Fleft"><button onmousedown="mousedown_tds_button(this)" onmouseup="mouseup_tds_button(this)" class="videoUploadButton orange_clr_imp" type="button" id="videoUploadButton"><span><div class="Fleft">Upload</div> </span></button></div>
				<div class="tds-button Fleft"><button onmousedown="mousedown_tds_button(this)" onmouseup="mouseup_tds_button(this)" class="videoEmbedButton" type="button" id="videoEmbedButton"><span><div class="Fleft">Embed</div> </span></button></div>
			<div class="clear"></div>
		...
		<div  id="uploadField" >
			...
			<div class="fl pl5" id="Uploadvideo<?php echo $browseid;?>"><input type="text" readonly id="fileInput<?php echo $browseid?>" class="width150px required" value="" name="fileInput"></div>
			<div class="fl">
			...
			<div class="clear"></div>
			<div class="wordcounter orange" id="fileError<?php echo $browseid?>"></div>
			<div class="seprator_5"></div>
		</div>
		
		
		<div class="dn" id="embededField" >
			<div class="fl">
...
<script>
	$(document).ready(function(){
		...
		$("#uploadmediaForm<?php echo $browseid?>").validate({
			submitHandler: function() {
				...
				var url = baseUrl+'admin/settings/manage_news/add_edit_news_video';
	...
	var url = baseUrl+'admin/settings/manage_news/deleteNewsVideoRowAdmin';
	var ID = new Array();
	if(id>0)
	{
		ID[0] = id;
