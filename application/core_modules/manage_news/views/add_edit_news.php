<?php if ( ! defined('BASEPATH')) exit('No direct script access allowed');
	...
	$titleInput = array(			
		...
		'id' 				=> 'title',
		'type' 				=> 'text',
		'class' 			=> 'textbox width468px required',
		'value' 			=> $title
	);
...
echo '
'.form_open_multipart('admin/settings/manage_news/save_news', 'class="form" id="add_edit_news" name="add_edit_news" ').'

<div class="width599px fl">
	<ul class="ul_relative">
			...
			<li class="frm_element_wrapper NIC">		
				<div class="sales_infmn" >
					<div id="myNicPanel">
					</div>
					<div id="descriptionPanelDiv" class="frm_element_wrapper NIC " >
		...
		echo '<li> <div class="tds-button fr pr25">
			<div class="seprator_20"></div>
						...
						<input type="button" value="Cancel" onClick="window.location.href=\''.base_url('admin/settings/manage_news').'\'" class="canclebtn">
					</div>';
...
$this->load->view('manage_pressRelease/supporting_matrial',array('section'=>'news')); ?>
</div>
